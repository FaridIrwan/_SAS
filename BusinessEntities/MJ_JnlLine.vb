Public Class MJ_JnlLine
    ...
    Private _mjjl_lineno As Integer
    Public Property mjjl_lineno() As Integer
        Get
            Return _mjjl_lineno
        End Get
    ...
    Private _mjjl_units As String
    Public Property mjjl_units() As String
        Get
            Return _mjjl_units
        End Get
        Set(ByVal value As String)
