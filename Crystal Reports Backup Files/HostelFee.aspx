<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" AutoEventWireup="false" MaintainScrollPositionOnPostback="true"
    CodeFile="HostelFee.aspx.vb" Inherits="HostelFee" Title="Setup - Hostel Fee" %>
                   ...
                   <div  style="border: thin solid #A6D9F4; width: 100%">
                        <table class="fields" style="width: 99%; height: 77%;">
                            <tr>
                                ...
                                <td class="fields" style="width: 156px; height: 26px">
                                </td>
                ...
                <td style="width: 71%; height: 149px; vertical-align: top;">
                    <asp:DataGrid ID="dgView" runat="server" AutoGenerateColumns="False" Width="100%"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="HDType" HeaderText="Fee Type" Visible="False"></asp:BoundColumn>
                            <asp:BoundColumn DataField="Priority" HeaderText="Priority"></asp:BoundColumn>
                            <asp:BoundColumn DataField="ObjectID" HeaderText="Object id" Visible="False"></asp:BoundColumn>
                        </Columns>
                    </asp:DataGrid>
                    &nbsp;&nbsp;
                    <asp:Label ID="Label7" runat="server" Text="Hostel Fee Code:" Width="103px" Visible="False"></asp:Label>
                    &nbsp;
                </td>
                <td style="width: 100%; height: 149px; vertical-align: top;">
                    <asp:DataGrid ID="dgViewType" runat="server" AutoGenerateColumns="False" Width="100%"
                        Height="123px">
                        <FooterStyle CssClass="dgFooterStyle" Height="20px" />
                        <SelectedItemStyle CssClass="dgSelectedItemStyle" />
                        <AlternatingItemStyle BackColor="Beige" CssClass="dgAlternatingItemStyle" Font-Bold="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="HAAmount" HeaderText="FeeAmount" Visible="False">
                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Right" />
                            </asp:BoundColumn>
                        </Columns>
