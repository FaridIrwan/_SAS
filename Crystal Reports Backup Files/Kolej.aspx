<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" AutoEventWireup="false" MaintainScrollPositionOnPostback="true" CodeFile="Kolej.aspx.vb" Inherits="Kolej" Title="Kolej Setup" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function validate() {
            var re = /\s*((\S+\s*)*)/;
            if (document.getElementById("<%=txtKolejCode.ClientID%>").value.replace(re, "$1").length == 0) {
                alert("Kolej Code Field Cannot Be Blank");
                document.getElementById("<%=txtKolejCode.ClientID%>").focus();
                return false;
            }
            var digits = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";
            var temp;
            for (var i = 0; i < document.getElementById("<%=txtKolejCode.ClientID %>").value.length; i++) {
                temp = document.getElementById("<%=txtKolejCode.ClientID%>").value.substring(i, i + 1);
                if (digits.indexOf(temp) == -1) {
                    alert("Enter Valid Kolej Code");
                    document.getElementById("<%=txtKolejCode.ClientID%>").focus();
                    return false;
                }
            }
            if (document.getElementById("<%=txtKolejDesc.ClientID%>").value.replace(re, "$1").length == 0) {
                alert(" Kolej Description Field Cannot Be Blank");
                document.getElementById("<%=txtKolejDesc.ClientID%>").focus();
                return false;
            }
        ...
        <table class="mainbg" style="width: 100%">
            <tr>
                ...
                <td align="right" class="pagetext" style="height: 39px">
                    <asp:Label ID="lblMenuName" runat="server" Text="Kolej" Width="253px"></asp:Label>
                </td>
            </tr>
        </table>
    </asp:Panel>
            ...
            <table class="fields" style="width: 100%; height: 100%; text-align: left;">
                ...
                <tr>
                    <td class="fields" style="width: 67px; height: 26px">
                        &nbsp;
                        <asp:Label ID="lbKolejCode" runat="server" Text="Kolej Code" Width="76px"></asp:Label>
                    </td>
                    <td style="width: 43px; height: 26px">
                        <asp:TextBox ID="txtKolejCode" runat="server" Width="142px" MaxLength="20"></asp:TextBox><span
                ...
                <tr>
                    <td class="fields" style="width: 67px; height: 21px">
                        &nbsp;
                        <asp:Label ID="lbKolejdesc" runat="server" Text="Kolej Description" Width="117px"></asp:Label>
                    </td>
                    <td style="width: 43px; height: 21px">
                        <asp:TextBox ID="txtKolejDesc" runat="server" Width="346px" MaxLength="50"></asp:TextBox><span
                            style="font-size: 11pt; color: #ff0066">*</span>
                    </td>
