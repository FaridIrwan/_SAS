<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" AutoEventWireup="false" MaintainScrollPositionOnPostback="true"
    CodeFile="Faculty.aspx.vb" Inherits="Faculty" Title="Faculty" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function validate() {
            var re = /\s*((\S+\s*)*)/;
            if (document.getElementById("<%=txtFacultyCode.ClientID%>").value.replace(re, "$1").length == 0) {
                alert("Faculty Code Field Cannot Be Blank");
                document.getElementById("<%=txtFacultyCode.ClientID%>").focus();
                return false;
            }
            ...
            if (document.getElementById("<%=txtFacultySDesc.ClientID%>").value.replace(re, "$1").length == 0) {
                alert("Faculty Short Description Field Cannot Be Blank");
                document.getElementById("<%=txtFacultySDesc.ClientID%>").focus();
                return false;
            }
        ...
        <table class="mainbg" style="width: 100%">
            <tr>
                ...
                <td align="right"  class="pagetext" style="height: 39px">
                    <asp:Label ID="lblMenuName" runat="server" Text="Faculty" Width="253px"></asp:Label>
                </td>
            </tr>
        </table>
    </asp:Panel>
            ...
            <table class="fields" style="width: 100%; height: 100%; text-align: left;">
                ...
                <tr>
                    <td class="fields" style="width: 67px; height: 26px">
                        &nbsp;
                        <asp:Label ID="Label1" runat="server" Text="Faculty Code" Width="76px"></asp:Label>
                    </td>
                    <td style="width: 43px; height: 26px">
                        <asp:TextBox ID="txtFacultyCode" runat="server" Width="142px" MaxLength="20"></asp:TextBox><span
                ...
                <tr>
                    <td class="fields" style="width: 67px; height: 21px">
                        &nbsp;
                        <asp:Label ID="Label2" runat="server" Text="Faculty Description" Width="117px"></asp:Label>
                    </td>
                    <td style="width: 43px; height: 21px">
                        <asp:TextBox ID="txtFacultyDesc" runat="server" Width="346px" MaxLength="50"></asp:TextBox><span
                            style="font-size: 11pt; color: #ff0066">*</span>
                    </td>
                ...
                <tr>
                    <td class="fields" style="width: 67px; height: 21px">
                        &nbsp;
                        <asp:Label ID="Label4" runat="server" Text="Faculty Short Description" Width="146px"></asp:Label>
                    </td>
                    <td style="width: 43px; height: 21px">
                        <asp:TextBox ID="txtFacultySDesc" runat="server"></asp:TextBox><span style="font-size: 11pt;
                            color: #ff0066">*</span>
                    </td>
                    <td style="width: 100px; height: 21px">
                    </td>
                ...
                <tr>
                    <td class="fields" style="width: 67px; height: 21px">
                        &nbsp;
                        <asp:Label ID="Label8" runat="server" Text="Faculty Incharge" Width="146px"></asp:Label>
                    </td>
                    <td style="width: 43px; height: 21px">
                        <asp:TextBox ID="txtFIncharge" runat="server" MaxLength="50" Width="346px"></asp:TextBox>
                    </td>
                    <td style="width: 100px; height: 21px">
                    </td>
                </tr>
                <tr>
                    <td class="fields" style="width: 67px; height: 21px">
                        &nbsp;
                        <asp:Label ID="Label3" runat="server" Text="GL Account" Width="117px"></asp:Label>
                    </td>
                    <td style="width: 43px; height: 21px">
                        <asp:TextBox ID="txtGLAccount" runat="server"></asp:TextBox><span style="font-size: 11pt;
                            color: #ff0066">*</span>
