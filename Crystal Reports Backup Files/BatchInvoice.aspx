<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" AutoEventWireup="false"
    CodeFile="BatchInvoice.aspx.vb" Inherits="BatchInvoice" Title="Untitled Page" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function getPrint() {
            ...
            window.open('../GroupReport/RptInvoiceViewer.aspx?batchNo=' + str1, 'SAS', 'width=700,height=500,resizable=1');
        }
    ...
    <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                                ...
                                <table style="width: 100%">
                                    <tr>
                                        ...
                                        <td style="height: 23px">
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
                                            <asp:Button ID="btnChangeProg" runat="server" Height="27px" OnClick="btnChangeProg_Click" 
                                                Text="Change of Program" Width="177px" Visible="false" />
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <asp:Button ID="btnChangeCdtHr" runat="server" Height="27px" OnClick="btnChangeCdtHr_Click" 
                                                Text="Change of Credit Hour" Width="177px" Visible="false"/>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <asp:Button ID="btnChangeHostel" runat="server" Height="27px" OnClick="btnChangeHostel_Click" 
                                                Text="Withdrawn from Hostel" Width="177px" Visible="false"/>
                                        </td>
                                    </tr>
                                </table>
                                <table style="width: 100%; height: 100%">
                                                ...
                                                <tr>
                                                    <td style="width: 100px">
                                                        <asp:Panel ID="Panel4" runat="server" Height="50px" Width="100%">
                                                            <asp:RadioButton ID="rbProYes" runat="server" Text="Yes" GroupName="GpProgram" /><br />
                                                            <asp:RadioButton ID="rbProNo" runat="server" Text="No" GroupName="GpProgram" /></asp:Panel>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td style="width: 100px; height: 61px;">
                                                        <asp:Panel ID="Panel5" runat="server" Height="50px" Width="100%">
                                                            <asp:RadioButton ID="rbSemYes" runat="server" Text="Yes" GroupName="GpSponsor" /><br />
                                                            <asp:RadioButton ID="rbSemNo" runat="server" Text="No" GroupName="GpSponsor" /></asp:Panel>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 100px; height: 12px">
                                                ...
                                                <tr>
                                                    <td style="width: 100px">
                                                        <asp:Panel ID="Panel6" runat="server" Height="50px" Width="100%">
                                                            <asp:RadioButton ID="rbHosYes" runat="server" Text="Yes" GroupName="GpHostel" /><br />
                                                            <asp:RadioButton ID="rbHosNo" runat="server" Text="No" GroupName="GpHostel" /></asp:Panel>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 100px; height: 12px">
                                    ...
                                    <tr>
                                            ...
                                            <table style="width: 100%;">
                                                ...
                                                <tr>
                                                    <td style="width: 59px; text-align: right">
                                                        <asp:RadioButton ID="rbSemAll" runat="server" Text="All" GroupName="gpSemester" />
                                                    </td>
                                                    <td style="width: 85px; text-align: right">
                                                        <asp:RadioButton ID="rbSemIndividual" runat="server" GroupName="gpSemester" Text="Individual" />
                                                    </td>
                                                    <td style="width: 100px">
                                                        &nbsp;
                                                        <asp:TextBox ID="txtSemster" runat="server" Width="18px"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 59px; text-align: right">
                                        ...
                                        <td style="width: 35%;">
                                            <table style="width: 100%;">
                                                <tr>
                                                    <td style="width: 5px; text-align: right; height: 14px;">
                                                    </td>
                                                    <td style="width: 100%; height: 14px;">
                                                        &nbsp;<asp:Label ID="Label12" runat="server" Text="Student Category" Width="100px"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                            ...
                            <table style="width: 100%;">
                                <tr>
                                    <td style="width: 100%; vertical-align: top;">
                                        ...
                                        &nbsp;&nbsp;
                                        <asp:Button ID="btnupload" runat="server" Text="Load template" />
                                        <br />
                                        <asp:CheckBox ID="chkStudent" runat="server" AutoPostBack="True" OnCheckedChanged="chkStudent_CheckedChanged" Text="Select All" />
        ...
        <asp:View ID="View4" runat="server">
            <table style="width: 100%">
                <tr>
                    <td style="width: 100%">                        
                        &nbsp;<asp:Panel ID="pnlViewChange" runat="server" Height="100%" Width="100%" Visible="False">
                                <table style="width: 100%;">
                                    <tr>
                                        <td style="width: 100%; vertical-align: top;">                                            
                                            <br />
                                            <asp:CheckBox ID="chkStudentProg" runat="server" 
