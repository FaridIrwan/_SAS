                        ...
                        <table class="fields" style="width: 100%; height: 100%">
                            ...
                            <tr>
                                ...
                                <td style="width: 43px; height: 26px">
                                    <asp:TextBox ID="txtSemesterCode" runat="server" Width="142px" MaxLength="20"></asp:TextBox><span
                            ...
                            <tr>
                                ...
                                <td style="width: 43px; height: 21px">
                                    <asp:TextBox ID="txtSem" runat="server" MaxLength="50" Width="59px"></asp:TextBox>
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="width: 43px; height: 21px">
                                    <asp:TextBox ID="txtSemester" runat="server" Width="346px" MaxLength="50"></asp:TextBox><span
                                        style="font-size: 11pt; color: #ff0066">*</span>
                                </td>
                                <td style="width: 100px; height: 21px">
                                </td>
