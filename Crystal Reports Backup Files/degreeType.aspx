    ...
    <script language="javascript" type="text/javascript">
        ...
        function validate() {
            ...
            if (document.getElementById("<%=txtDegreeCode.ClientID%>").value.replace(re, "$1").length == 0) {
                alert("Degree Code Field Cannot Be Blank");
            ...
            if (document.getElementById("<%=txtDegreeName.ClientID%>").value.replace(re, "$1").length == 0) {
                alert("Degree Description Field Cannot Be Blank");
                        ...
                        <table class="fields" style="width: 100%; height: 100%">
                            ...
                            <tr>
                                ...
                                <td style="width: 43px; height: 26px">
                                    <asp:TextBox ID="txtDegreeCode" runat="server" Width="142px" MaxLength="20"></asp:TextBox><span
                            ...
                            <tr>
                                ...
                                <td style="width: 43px; height: 21px">
                                    <asp:TextBox ID="txtDegreeName" runat="server" Width="346px" MaxLength="50"></asp:TextBox><span
                                        style="font-size: 11pt; color: #ff0066">*</span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="width: 43px; height: 21px">
                                    <asp:TextBox ID="txtShortName" runat="server" Width="142px" MaxLength="20"></asp:TextBox><span
                                        style="font-size: 11pt; color: #ff0066">*</span>
                                </td>
                                <td style="width: 100px; height: 21px">
                                </td>
