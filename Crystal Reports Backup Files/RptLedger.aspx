<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" AutoEventWireup="false"
    CodeFile="RptLedger.aspx.vb" Inherits="RptLedger" Title="Student Ledger Report" %>
        ...
        function dllValues() {
            ...
            if (document.getElementById("<%=ChkDateRange.ClientID%>").checked) {
                ...
                if (document.getElementById("<%=ddlLedgerType.ClientID %>").value == "0") {
                    window.open('../GroupReport/RptLedgerStudentViewer.aspx?fdate=' + fromdate1 + '&tdate=' + todate1, 'SAS', 'width=700,height=500,resizable=1');
                    return true
                }
                else {
                    window.open('../GroupReport/RptLedgerSponsorViewer.aspx?fdate=' + fromdate1 + '&tdate=' + todate1, 'SAS', 'width=700,height=500,resizable=1');
                    return true
                }
            }
            else {
