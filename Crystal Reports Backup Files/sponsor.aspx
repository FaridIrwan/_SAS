<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" AutoEventWireup="false" MaintainScrollPositionOnPostback="true"
    CodeFile="Sponsor.aspx.vb" Inherits="Sponsor" Title="Sponsor-SAS" %>
                        ...
                        <table class="fields" style="width: 100%; height: 100%;">
                            ...
                            <tr>
                                ...
                                <td style="width: 110px; height: 16px">
                                    <asp:TextBox ID="txtSponsorCode" runat="server" Width="142px" MaxLength="20"></asp:TextBox><span
                            ...
                            <tr>
                                ...
                                <td style="width: 110px; height: 21px">
                                    <asp:TextBox ID="txtSponsorName" runat="server" Width="346px" MaxLength="50"></asp:TextBox><span
                                        style="font-size: 11pt; color: #ff0066">*</span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="width: 110px; height: 21px">
                                    <asp:TextBox ID="txtSponsorType" runat="server" MaxLength="50" Width="346px"></asp:TextBox><span
                                        style="font-size: 11pt; color: #ff0066">*</span>
                                </td>
                                <td style="width: 248px; height: 21px">
                                    <span style="font-size: 11pt; color: #ff0066"></span>
                            ...
                            <tr>
                                ...
                                <td style="width: 110px; height: 24px">
                                    <asp:TextBox ID="txtGlAccount" runat="server" MaxLength="20" Width="142px" CausesValidation="True"></asp:TextBox><span
                                        style="font-size: 11pt; color: #ff0066">*</span>
