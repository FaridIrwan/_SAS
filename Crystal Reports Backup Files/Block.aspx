<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" AutoEventWireup="false" MaintainScrollPositionOnPostback="true" CodeFile="Block.aspx.vb" Inherits="Block" title="Untitled Page" %>
                    ...
                    <tr>
                        ...
                        <td style="width: 14px; height: 14px">
                          ...
                          <td >
                           ...
                           <table  style="border-collapse:collapse;" class="menuoff" onmouseover="className='menuon';" onmouseout="className='menuoff';">
                           <tr>
                           <td><asp:ImageButton ID="ibtnPosting" runat="server" ImageUrl="~/images/gposting.png" ToolTip="Cancel" /></td>
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td style="width: 43px; height: 26px">
                                <asp:TextBox ID="txtBlockCode" runat="server" Width="142px" MaxLength="20"></asp:TextBox><span
                        ...
                        <tr>
                            ...
                            <td style="width: 43px; height: 21px">
                                <asp:TextBox ID="txtBlockDesc" runat="server" Width="346px" MaxLength="50"></asp:TextBox><span
                                    style="font-size: 11pt; color: #ff0066">*</span></td>
