<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" AutoEventWireup="false" CodeFile="RptTransactionDetail.aspx.vb" Inherits="RptTransactionDetail" Title="Transaction Detail Report" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    function dllValues() {
        ...
        if ((document.getElementById("<%=ddlStuStatus.ClientID%>").value == "-1") && (document.getElementById("<%=ddlFaculty.ClientID%>").value == "-1") && (document.getElementById("<%=ddlProgram.ClientID%>").value == "-1") && (document.getElementById("<%=ddlSponsor.ClientID%>").value == "-1") && (document.getElementById("<%=ChkDateRange.ClientID%>").checked == false)) {
                ...
                lbl = true;
                new_window = window.open('../GroupReport/RptTransactionDetailViewer.aspx?fdate=' + fromdate1 + '&tdate=' + todate1, 'SAS', 'width=700,height=500,resizable=1'); new_window.focus();
                return lbl;
            }
            else {
    ...
    <asp:Panel ID="Panel1" runat="server" Width="100%">
        <table style="background-image: url(../images/Sample.png);">
            <tr>
                        ...
                        <tr>
                            <td style="width: 2%; height: 14px">
                                <asp:ImageButton ID="ibtnPosting" runat="server" ImageUrl="~/images/gposting.png"
                                    ToolTip="Cancel" /></td>
                            <td style="width: 2%; height: 14px">&nbsp;<asp:Label ID="Label6" runat="server" Text="Posting"></asp:Label></td>
                        </tr>
                    </table>
                </td>
                <td>
                ...
                <td style="width: 2%; height: 14px">
                    <asp:TextBox ID="txtRecNo" runat="server" ReadOnly="true" CssClass="text_box" Width="52px" AutoPostBack="True" Style="text-align: right" disabled="disabled" TabIndex="1" dir="ltr"></asp:TextBox></td>
                <td style="width: 2%; height: 14px">
    ...
    <table style="width: 100%">
        <tr>
            ...
            <td style="width: 1005px; height: 16px">&nbsp;<fieldset style="width: 100%; border: thin solid #A6D9F4;">
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        <td colspan="2" style="height: 16px">
                            <asp:Label ID="Label9" runat="server" Text="By Faculty"></asp:Label></td>
                        <td colspan="5" style="height: 16px">
                            <asp:DropDownList ID="ddlFaculty" runat="server" Width="135px" onmousedown="this.style.width=''" AppendDataBoundItems="True" OnSelectedIndexChanged="ddlFaculty_SelectedIndexChanged" AutoPostBack="True">
                            </asp:DropDownList></td>
                    </tr>
                    <tr>
                        <td colspan="2" style="height: 16px">
                            <asp:Label ID="Label10" runat="server" Text="By Program"></asp:Label></td>
                        <td colspan="5" style="height: 16px">
                            <asp:DropDownList ID="ddlProgram" runat="server" Width="135px" onmousedown="this.style.width=''" AppendDataBoundItems="True" AutoPostBack="True" OnSelectedIndexChanged="ddlProgram_SelectedIndexChanged">
                            </asp:DropDownList></td>

                    </tr>
                    <tr>
                        <td colspan="2" style="height: 16px">
                            <asp:Label ID="Label4" runat="server" Text="Sponsor" Style="position: static"></asp:Label></td>
                        <td colspan="5" style="height: 16px">
                            <asp:DropDownList ID="ddlSponsor" runat="server" Width="135px" onmousedown="this.style.width=''" Style="position: static" AppendDataBoundItems="True" AutoPostBack="True" OnSelectedIndexChanged="ddlSponsor_SelectedIndexChanged">
                                <asp:ListItem Value="-1">-- Select --</asp:ListItem>
                    ...
                    <tr>
                        <td style="width: 85px; height: 16px">
                            <asp:CheckBox ID="ChkDateRange" runat="server" Text="Date Range" Width="81px" OnCheckedChanged="ChkDateRange_CheckedChanged" AutoPostBack="True" /></td>
                        ...
                        <td style="width: 10px; height: 16px">
                            <asp:Image ID="ibtnFDate" runat="server" ImageUrl="~/images/cal.gif" /></td>
                        ...
                        <td style="width: 648px; height: 16px">
                            <asp:Image ID="ibtnTodate" runat="server" ImageUrl="~/images/cal.gif" /></td>
                        <td style="width: 1px; height: 16px"></td>
                        <td style="width: 1px; height: 16px"></td>
                        <td style="width: 1px; height: 16px"></td>
                    </tr>
        ...
        <tr>
            ...
            <td style="width: 1005px; height: 16px">&nbsp;<fieldset style="width: 100%; border: thin solid #A6D9F4;">
                ...
                <table style="width: 100%">
                    <tr>
                        <td colspan="2" style="width: 224px; height: 16px">&nbsp;<asp:RadioButton ID="RdbtnStudentID" runat="server" Text="Matric Id" GroupName="RecordSort" AutoPostBack="True" OnCheckedChanged="RdbtnStudentID_CheckedChanged" /></td>
                        <td style="width: 458px; height: 16px"></td>
                        <td style="width: 180px; height: 16px"></td>
                        <td style="width: 10px; height: 16px"></td>
                    </tr>
                    <tr>
                        <td colspan="2" style="width: 224px; height: 15px">&nbsp;<asp:RadioButton ID="RdbtnStudentName" runat="server" Text="Student Name" Width="123px" GroupName="RecordSort" AutoPostBack="True" OnCheckedChanged="RdbtnStudentName_CheckedChanged" /></td>
