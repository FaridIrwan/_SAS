<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" AutoEventWireup="false"
    CodeFile="RptDailyCashCollection.aspx.vb" Inherits="RptDailyCashCollection" Title="Daily Cash Collection" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function dllValues() {
            ...
            var todate1 = "0"
            var lbl = false
                if ((document.getElementById("<%=ddlStuStatus.ClientID%>").value == "-1") && (document.getElementById("<%=ChkDateRange.ClientID%>").checked == false) && (document.getElementById("<%=ddlUser.ClientID%>").value == "-1")) {
                    if (confirm("Do you Want to Show All Records?")) {
                        ...
                        lbl = true;
                        new_window = window.open('../GroupReport/RptDailyCashCollectionViewer.aspx?fdate=' + fromdate1 + '&tdate=' + todate1, 'SAS', 'width=700,height=500,resizable=1'); new_window.focus();
                        return lbl;
                    }
                    else {
        ...
        <table class="mainbg" style="width: 100%;">
            <tr>
                ...
                <td class="pagetext" style="height: 39px">
                    <asp:Label ID="lblMenuName" runat="server" Text="Daily Cash Collection" 
                        ...
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td style="height: 16px">
                                    <asp:DropDownList ID="ddlUser" runat="server" AutoPostBack="True" AppendDataBoundItems="true"  
                                        OnSelectedIndexChanged="ddlUser_SelectedIndexChanged" Width="135px">
                                    </asp:DropDownList>
                                </td>
