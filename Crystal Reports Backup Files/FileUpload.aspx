<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" AutoEventWireup="false" MaintainScrollPositionOnPostback="true"
    CodeFile="FileUpload.aspx.vb" Inherits="FileUpload" Title="Untitled Page" Culture="auto"
                ...
                <td>
                    <table style="border-collapse: collapse;" class="menuoff" onmouseover="className='menuon';"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="Label8" runat="server" Text="Posting"></asp:Label>
                            </td>
                        </tr>
                    </table>
                </td>
                        ...
                        <table>
                            <tr>
                                ...
                                <td style="width: 142px">
                                    <asp:TextBox ID="txtColumns" runat="server" Width="80px"></asp:TextBox><span style="color: #ff3366">*</span>
                                </td>
                                <td style="width: 100px">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="width: 142px; height: 25px;">
                                    <asp:TextBox ID="txtMatrixNo" runat="server" MaxLength="2" Width="80px"></asp:TextBox><span
                            ...
                            <tr>
                                ...
                                <td style="width: 142px; height: 25px;">
                                    <asp:TextBox ID="txtICNo" runat="server" MaxLength="2" Width="80px"></asp:TextBox><span
                                        style="color: #ff3366">*</span>
                                </td>
                                <td style="width: 100px; height: 25px;">
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="width: 142px; height: 25px;">
                                    <asp:TextBox ID="txtName" runat="server" MaxLength="2" Width="80px"></asp:TextBox><span
                                        style="color: #ff3366">*</span>
                                </td>
                                <td style="width: 100px; height: 25px;">
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="width: 142px; height: 22px;">
                                    <span style="color: #ff3366">
                                        <asp:TextBox ID="txtAmount" runat="server" MaxLength="2" Width="80px"></asp:TextBox>*</span>
                                </td>
                                <td style="width: 100px; height: 22px;">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="width: 142px">
                                    <span style="color: #ff3366">
                                        <asp:TextBox ID="txtDelimeter" runat="server" MaxLength="2" Width="80px"></asp:TextBox>*</span>
                                </td>
                                <td style="width: 100px">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="width: 142px; height: 24px">
                                    <asp:TextBox ID="txtStuName" runat="server" Width="80px"></asp:TextBox><span style="color: #ff3366">*</span>
                                </td>
                                <td style="width: 100px; height: 24px">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="width: 142px">
                                    <asp:TextBox ID="txtRef" runat="server" Width="80px"></asp:TextBox><span style="color: #ff3366">*</span>
                                </td>
                                <td style="width: 100px">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="width: 142px">
                                    <asp:TextBox ID="txtReference" runat="server" MaxLength="2" Width="80px"></asp:TextBox><span
                                        style="color: #cc3366">*</span><span style="background-color: #ff3366"></span>
                                </td>
                                <td style="width: 100px">
                                </td>
                            </tr>
