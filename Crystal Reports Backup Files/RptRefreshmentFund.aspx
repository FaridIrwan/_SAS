<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" AutoEventWireup="false" Title="Report Dana Makan Minum"
    CodeFile="RptRefreshmentFund.aspx.vb" Inherits="RptRefreshmentFund" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function dllValues() {
            ...
            var todate1 = "0"
            var lbl = false
            if ((document.getElementById("<%=ddlStatus.ClientID%>").value == "-1") && (document.getElementById("<%=ddlFaculty.ClientID%>").value == "-1") && (document.getElementById("<%=ddlProgram.ClientID%>").value == "-1")) {
                if (confirm("Do you Want to Show All Records?")) {
                        todate1 = document.getElementById("<%=txtTodate.ClientID%>").value
                    lbl = true;
                    OpenPopup('../GroupReport/RptRefreshmentFundViewer.aspx?tdate=' + todate1, 'Refreshment Fund Report', '700', '650')
                    //new_window = window.open('RptDanaMakanMinumQuery.aspx?tdate=' + todate1, 'SAS', 'width=700,height=500,resizable=1'); new_window.focus();
                    return lbl;
                }
                else {
        ...
        function dllValues1() {
            ...
            if ((document.getElementById("<%=ddlStatus.ClientID%>").value == "-1") && (document.getElementById("<%=ddlFaculty.ClientID%>").value == "-1") && (document.getElementById("<%=ddlProgram.ClientID%>").value == "-1")) {
                if (confirm("Do you Want to Show All Records?")) {
                    lbl = true;
                    OpenPopup('../GroupReport/RptRefreshmentFundViewer.aspx', 'Refreshment Fund Report', '700', '650')
                    //new_window = window.open('RptDanaMakanMinumQuery.aspx', 'SAS', 'width=700,height=500,resizable=1'); new_window.focus();
                    return lbl;
                }
                else {
                    if (document.getElementById("<%=ddlStatus.ClientID%>").value == "-1") {
    ...
    <asp:Panel ID="Panel1" runat="server" Width="100%">
        ...
        <table class="mainbg" style="width: 98%;">
            <tr>
                ...
                <td class="pagetext" style="height: 39px; text-align: right">
                    <asp:Label ID="lblMenuName" runat="server" Text="Refreshment Fund Report" Width="450px"></asp:Label>
                </td>
            </tr>
        </table>
    </asp:Panel>
    ...
    <asp:Panel ID="Panel2" runat="server" Width="100%">
        <table style="width: 100%">
            <tr>
                ...
                <td style="width: 98%;">
                    <asp:Label ID="lblMsg" runat="server" CssClass="lblError" Style="text-align: left" Width="500px"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="width: 1px;"></td>
                        ...
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td style="height: 16px">
                                    <asp:DropDownList ID="ddlStatus" runat="server" Width="135px" AutoPostBack="true" >
            ...
            <tr>
                ...
                <td style="width: 98%; height: 16px">
                    <fieldset style="width: 100%; border: thin solid #A6D9F4;">
                        <legend><strong><span style="color: #000000;">Record Sort By</span></strong></legend>
                        <table style="width: 100%">
                            <tr>
                                <td style="height: 16px; width: 224px;">&nbsp;
                                    <asp:RadioButton ID="rdbtnstudid" runat="server" Text="Matric No" GroupName="RecordSort" AutoPostBack ="true" />
                                </td>
                            ...
                            <tr>
                                <td style="height: 16px; width: 224px;">&nbsp;
                                    <asp:RadioButton ID="rdbtnstudname" runat="server" Text="Student Name" Width="123px" AutoPostBack="true" />
                                </td>
                                <td style="width: 458px; height: 16px"></td>
                                <td style="width: 180px; height: 16px"></td>
                                <td style="width: 10px; height: 16px"></td>
