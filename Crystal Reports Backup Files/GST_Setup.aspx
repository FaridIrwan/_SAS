...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script language="javascript" type="text/javascript">
        function validate() {
            ...
            if (document.getElementById("<%=ddlTaxCode.ClientID%>").value == "0") {
            ...
            if (document.getElementById("<%=ddlTaxMode.ClientID%>").value == "0") {
                        ...
                        <table class="fields" style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td colspan="2" class="auto-style2">
                                    <asp:TextBox ID="_TaxType" runat="server" Width="346px" MaxLength="50" TextMode="MultiLine" Height="21px"></asp:TextBox><span
                            ...
                            <tr>
                                ...
                                <td class="fields" style="height: 26px" colspan="2">
                                    ...
                                    </asp:DropDownList><span style="font-size: 11pt; color: #ff0066">*</span>
                                </td>
