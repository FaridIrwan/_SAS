<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="false" CodeFile="Pre-SponsorAllocation.aspx.vb" Inherits="SponsorAllocation" Title="SponsorAllocation" %>
        ...
        <table class="mainbg" style="width: 100%;">
            <tr>
                ...
                <td class="pagetext" style="height: 39px; text-align: right;">
                    <asp:Label ID="lblMenuName" runat="server" Text="Pre-SponsorAllocation" Width="309px"></asp:Label>
                </td>
            </tr>
        </table>
                        ...
                        <table style="width: 464px">
                            ...
                            <tr>
                                ...
                                <td style="width: 13%; height: 25px;">
                                    <asp:Label ID="Label48" runat="server" Style="text-align: left" 
                                        Text="AutoNumber" Width="97px"></asp:Label>
                                </td>
                                <td colspan="1" style="height: 25px; width: 34px;">
                                </td>
                                <td style="height: 25px; width: 1209px;">
                                    <asp:TextBox ID="txtAutoNum" runat="server" MaxLength="20" 
                            ...
                            <tr>
                                ...
                                <td style="width: 13%; height: 25px;">
                                    <asp:Label ID="Label7" runat="server" Text="Total Allocated" Width="97px" 
                                        Style="text-align: left"></asp:Label>
                                </td>
                                <td style="width: 34px; height: 25px;">
                                </td>
                                <td style="width: 1209px; height: 25%; text-align: left">
                                    <asp:TextBox ID="txtAllAmount" runat="server" MaxLength="20" 
                                        Style="text-align: right" Width="103px"></asp:TextBox>
                                </td>
                                ...
                                <td style="width: 1266px; height: 25px">
                                    &nbsp;<span style="color: #ff0000">*</span></td>
                                <td style="width: 1266px; height: 25px">
                                    <asp:Label ID="Label9" runat="server" Style="text-align: left" 
                                        Text="Transaction Date" Width="97px"></asp:Label>
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="width: 1209px; text-align: left; height: 25px;">
                                    <asp:TextBox ID="txtspnAmount" runat="server" MaxLength="20" 
                                        Style="text-align: right" Width="142px"></asp:TextBox>
                                </td>
                                ...
                                <span style="color: #ff0000">
                                    <asp:TextBox ID="txtAllocateAmount" runat="server" AutoPostBack="True" 
                                        Height="15px" MaxLength="20" OnTextChanged="txtAllocateAmount_TextChanged" 
                                        ReadOnly="True" Style="text-align: right" Width="103px"></asp:TextBox>
                                    </span>
                                </td>
                                <td style="width: 49px; height: 25px;">
                                    <span
                            ...
                            <tr>
                                ...
                                <td style="width: 1266px; height: 25px">
                                    &nbsp;</td>
                                <td style="width: 1266px; height: 25px">
                                    <asp:Label ID="Label15" runat="server" Text="Select Student manually" 
