                        ...
                        <table class="fields" style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td style="height: 26px" colspan="2">
                                    <asp:TextBox ID="txtFundCode" runat="server" Width="142px" MaxLength="20"></asp:TextBox><span
                            ...
                            <tr>
                                ...
                                <td style="height: 21px" colspan="2">
                                    <asp:TextBox ID="txtFundName" runat="server" Width="346px" MaxLength="50"></asp:TextBox><span
                                        style="font-size: 11pt; color: #ff0066">*</span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="height: 25px;" colspan="2">
                                    <asp:TextBox ID="txtGlAccount" runat="server" Width="142px" MaxLength="20"></asp:TextBox><span
                                        style="font-size: 11pt; color: #ff0066">*</span><asp:Button ID="Check" runat="server"
                                            Text="Check" />
                                    &nbsp;
