<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" MaintainScrollPositionOnPostback="true" 
    AutoEventWireup="false" CodeFile="Department.aspx.vb" Inherits="Department" Title="Department Setup Page" %>
            ...
            <tr>
                ...
                <td>
                    <table style="border-collapse: collapse;" class="menuoff" onmouseover="className='menuon';"
                        ...
                        <tr>
                            <td style="width: 3%; height: 14px">
                                <asp:ImageButton ID="ibtnRefresh" runat="server" ImageUrl="~/images/refresh.png" ToolTip="View" />
                            </td>
                            <td style="width: 3%; height: 14px">
