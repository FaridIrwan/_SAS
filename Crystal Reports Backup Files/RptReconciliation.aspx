<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" AutoEventWireup="false"
    CodeFile="RptReconciliation.aspx.vb" Inherits="RptReconciliation" Title="Reconciliation Report" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function dllValues() {
            ...
            if (document.getElementById("<%=ddlReconcilation.ClientID %>").value == "-1") {
                alert("Select a Reconciliation Type")
                return true
            }

            if (document.getElementById("<%=ddlReconcilation.ClientID %>").value == "0") {
                if ((document.getElementById("<%=ddlFaculty.ClientID%>").value == "-1") && (document.getElementById("<%=ddlProgram.ClientID%>").value == "-1") && (document.getElementById("<%=ChkDateRange.ClientID%>").checked == false)) {
                    if (confirm("Do you Want to Show All Records?")) {
                        new_window = window.open('../GroupReport/RptReconciliationViewer.aspx', 'SAS', 'width=700,height=500,resizable=1'); new_window.focus();
                        return true;
                    }
                }
                else {
                    ...
                    new_window = window.open('../GroupReport/RptReconciliationViewer.aspx?fdate=' + fromdate1 + '&tdate=' + todate1, 'SAS', 'width=700,height=500,resizable=1'); new_window.focus();
                    return true;
                }
            }
            else {
                if ((document.getElementById("<%=ddlSponsor.ClientID%>").value == "-1") && (document.getElementById("<%=ChkDateRange.ClientID%>").checked == false)) {
                    if (confirm("Do you Want to Show All Records?")) {
                        new_window = window.open('../GroupReport/RptReconciliationViewer.aspx', 'SAS', 'width=700,height=500,resizable=1'); new_window.focus();
                        return true;
                    }
        ...
        <table class="mainbg" style="width: 100%;">
            <tr>
                <td style="width: 494px; height: 39px;">
                    <asp:SiteMapPath ID="SiteMapPath1" runat="server" Width="232px">
                    </asp:SiteMapPath>
                </td>
                <td align="right" class="pagetext" style="height: 39px">
                    <asp:Label ID="lblMenuName" runat="server" Text="University Fund" Width="390px"></asp:Label>
                </td>
            </tr>
        </table>
    </asp:Panel>
                    ...
                    <table style="width: 100%" id="TABLE1" onclick="return TABLE1_onclick()">
                        <tr>
                            <td colspan="2" style="height: 16px">
                                <asp:Label ID="Label12" runat="server" Text="Reconciliation By"></asp:Label>
                            </td>
                            <td style="height: 16px">
                                <asp:DropDownList ID="ddlReconcilation" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlReconcilation_SelectedIndexChanged">
                            ...
                            <td style="height: 16px" colspan="2">
                                <asp:Label ID="lblsponsor" runat="server" Text="By Sponsor" Width="63px"></asp:Label>
                            </td>
                            <td style="text-align: left; height: 16px" colspan="4">
                                <asp:DropDownList ID="ddlSponsor" runat="server" AppendDataBoundItems="True" AutoPostBack="True"
                                    onmousedown="this.style.width='auto';" OnSelectedIndexChanged="ddlSponsor_SelectedIndexChanged1"
                                    Width="135px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" style="height: 17px">
                                <asp:Label ID="lblfaculty" runat="server" Text="By Faculty"></asp:Label>
                            </td>
                            <td colspan="6" style="height: 17px">
                                <asp:DropDownList ID="ddlFaculty" runat="server" Width="135px" onmousedown="this.style.width='auto';"
                        ...
                        <tr>
                            <td colspan="2" style="height: 17px">
                                <asp:Label ID="lblprogram" runat="server" Text="By Program" Width="57px"></asp:Label>
                            </td>
                            <td colspan="6" style="height: 17px">
                                <asp:DropDownList ID="ddlProgram" runat="server" Width="135px" onmousedown="this.style.width='auto';"
                        ...
                        <tr>
                            ...
                            <td style="width: 48px; height: 16px; text-align: right;">
                            ...
                            <td style="width: 43px; height: 16px; text-align: right;">
