<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" AutoEventWireup="false"
    CodeFile="RptStudentAgeing.aspx.vb" Inherits="RptStudentAgeing" Title="Student Ageing Report" %>
        ...
        function dllValues1() {
            ...
            if ((document.getElementById("<%=ddlStuStatus.ClientID%>").value == "-1") && (document.getElementById("<%=ddlFaculty.ClientID%>").value == "-1") && (document.getElementById("<%=ddlProgram.ClientID%>").value == "-1") ) {
                if (confirm("Do You Want To Show All Records?")) {
                    ...
                    lbl = true;
                    OpenPopup('../GroupReport/RptStudentAgeingViewer.aspx?tdate=' + todate1, 'Out Standing Report', '700', '650')
                    //window.open('RptStuAgeingCRFormFinal.aspx?tdate=' + todate1, 'SAS', 'width=700,height=500,resizable=1');
                    return lbl;
                }
                else {
                ...
                todate1 = document.getElementById("<%=txtTodate.ClientID%>").value
                OpenPopup('../GroupReport/RptStudentAgeingViewer.aspx?tdate=' + todate1, 'Student Ageing Report', '700', '650')
                //new_window = window.open('RptStuAgeingCRFormFinal.aspx?tdate=' + todate1, 'SAS', 'width=700,height=500,resizable=1'); new_window.focus();
                return true;
            }
        }
            ...
            <td width="98%">
                <fieldset style="width: 100%; border: thin solid #A6D9F4;">
                    ...
                    <table style="width: 100%">
                        ...
                        <%--<tr>
                            <td style="height: 16px">
                                <asp:Label ID="Label4" runat="server" Text="By Program"></asp:Label>
                            </td>
                            <td style="height: 16px">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Label ID="lblPeriod" runat="server" Text="30,60,90"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </td>
