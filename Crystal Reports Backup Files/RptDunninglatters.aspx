<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" AutoEventWireup="false"
    CodeFile="RptDunninglatters.aspx.vb" Inherits="RptDunninglatters" Title="Dunning latters" %>
        ...
        <ContentTemplate>--%>
                ...
                <fieldset style="width: 99%;border: thin solid #A6D9F4;">
                    ...
                    <table style="width: 100%">
                        ...
                        <tr>
                            <td colspan="2" style="height: 88px; vertical-align: top;">
                            ...
                            <td colspan="2" style="height: 88px">
                                <asp:TextBox ID="txtMsg" runat="server" EnableTheming="False" Height="108px" 
                                    TextMode="MultiLine" Width="519px"></asp:TextBox><span
                                    style="color: #ff0000">*</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="width: 1833px; height: 16px">
                            </td>
                        </tr>
                        </table>
                </fieldset>
