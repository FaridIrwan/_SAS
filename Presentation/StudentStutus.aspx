                    ...
                    <div style="border: thin solid #A6D9F4; width: 100%">
                        <table class="fields" style="width: 100%; height: 100%">
                            ...
                            <tr>
                                ...
                                <td style="width: 43px; height: 26px">
                                    <asp:TextBox ID="txtStatusCode" runat="server" Width="142px" MaxLength="20"></asp:TextBox>
                                </td>
                                <td style="width: 100px; height: 26px">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="width: 43px; height: 21px">
                                    <asp:TextBox ID="txtStatusDesc" runat="server" Width="346px" MaxLength="50"></asp:TextBox>
                                </td>
