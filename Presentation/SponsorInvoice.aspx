<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" AutoEventWireup="false" MaintainScrollPositionOnPostback="true"
    CodeFile="SponsorInvoice.aspx.vb" Inherits="SponsorInvoice" Title="Welcome To SAS" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
       ...
       // }
        ...
        function CheckStudent() {
            ...
            var hfProgramCount = document.getElementById("<%=hfProgramCount.ClientID%>").value
            if (hfStudentCount > 0) {
                var new_window = window.open('StudentFee.aspx', 'Hanodale', 'width=520,height=500,resizable=0');
                new_window.focus();
            }
            else {
    ...
    function dllValues() {
        //  window.open('../GroupReport/RptSponsorCoverLetterViewer.aspx', 'SAS', 'width=700,height=500,resizable=1');
        var new_window = window.open('../GroupReport/RptSponsorCoverLetterViewer.aspx', 'SAS', 'width=700,height=500,resizable=1');
        new_window.focus();
        return true;
    }
                                    ...
                                    <ul id="navbar">
                                        <li><a href="#">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="#">
                                                    <asp:ImageButton ID="ibtnOthers" runat="server" ImageUrl="~/images/post.png" /></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </div>
...
<ContentTemplate>--%>
    ...
    <table>
        <tr>
            <td style="width: 134px; height: 26px; text-align: center;">
             <asp:Label ID="lblMsg" runat="server" CssClass="lblError" Style="text-align: center" Width="450px"></asp:Label>
            </td>
        </tr>
    </table>
    <table>        
    ...
    <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                        ...
                        <div style="border: thin solid #A6D9F4; width: 100%">
                            <asp:Panel ID="pnlBatch" runat="server" Height="100%" Width="100%">
                                    ...
                                    <tr>
                                        <td style="height: 138px;">
                                            <table style="width: 50%">
                                                <tr>
                                                    ...
                                                    <td colspan="3" style="height: 23px">
                                                        <asp:TextBox ID="txtBatchNo" runat="server" Width="142px" Enabled ="false"></asp:TextBox>&nbsp;
                                                    </td>
                                                    <td style="width: 81px; height: 23px">
                                                        <span style="color: #ff0000"></span>
                                                    </td>
                                                    <td style="width: 133px; height: 23px">&nbsp;</td>
                                                    <td style="width: 100px;" rowspan="6">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <%-- <td style="width: 133px; height: 25px" rowspan="4">
                                                        <asp:Panel ID="pnlSponCoverLetter" runat="server" Height="100%" Width="100%" Visible="false">
                                                            <table>
                                                                <tr>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="lblSCLCode" runat="server" Text="Code"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        <asp:DropDownList ID ="ddlSponCoverLetter" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlSponCoverLetter_SelectedIndexChanged"></asp:DropDownList>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <td colspan="4">
                                                                        <asp:Label ID="lblSCLMsg" runat="server" CssClass="lblError" Style="text-align: justify"></asp:Label>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </asp:Panel>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="height: 25px; vertical-align: top;" colspan="4">
                                                        <asp:TextBox ID="txtDesc" runat="server" Height="20px" MaxLength="150"
                                            ...
                                            <table width="60%">
                                                <tr>
                                                    <td>&nbsp;</td>
                                                    <td style="width: 229px; padding-left: 5px">&nbsp;</td>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;
                                                    </td>
                                            ...
                                            <table>
                                                <tr>
                                                    ...
                                                    <td style="width: 4px; height: 23px;">
                                                        ...
                                                        <asp:HiddenField ID="hfProgramCount" runat="server" Value="0" />
                                                    </td>
                                            ...
                                            <asp:DataGrid ID="dgFeeType" runat="server" AutoGenerateColumns="False" Width="100%"
                                                ...
                                                <Columns>
                                                    <asp:TemplateColumn HeaderText="Select" Visible ="true">
                                                        <ItemTemplate>
                                                            <asp:CheckBox ID="chkView" runat="server" AutoPostBack="true" Checked="true"/>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                ...
                                <table style="width: 100%; text-align: right;">
                                    <tr>
                                        <td style="width: 76%">
                                            <asp:Label ID="lblTotalFeeAmt" runat="server" Text="Total Amount" Width="65px" Visible="False"></asp:Label>
                                        </td>
                                        <td style="text-align: left">
                                            <asp:TextBox ID="txtTotalFeeAmt" runat="server" Width="106px" Visible="False" Style="text-align: right" Enabled="false"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                                <table style="width: 100%; text-align: right;">
                                    <tr>
                                        <td width="100%" style="height: 261px">
                                            <asp:CheckBox ID="chkSelectAll" runat="server" AutoPostBack="True" OnCheckedChanged="chkSelectAll_CheckedChanged" Text="Select All" Visible="false" />
                                            <asp:DataGrid ID="dgView" runat="server" AutoGenerateColumns="False" Width="100%"
                                                ...
                                                <%--<Columns>
                                                    ...
                                                    <asp:BoundColumn DataField="ReferenceCode" HeaderText="Fee Code"></asp:BoundColumn>
                                                    <asp:BoundColumn DataField="Description" HeaderText="Fee Desc" FooterText="Total"></asp:BoundColumn>
                                                    <asp:TemplateColumn HeaderText="Fee Amount">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtFeeAmt" runat="server" Width="98px" AutoPostBack="True" OnTextChanged="txtFeeAmt_TextChanged"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="Actual Fee Amount" FooterText="Total">
                                                        <ItemTemplate>
                                                            <%# GSTActAmt(Eval("TransactionAmount"), Eval("GSTAmount"), Eval("TaxId"), Eval("ReferenceCode"))%>
                                                        </ItemTemplate>
                                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                                            Font-Underline="False" HorizontalAlign="Right" />
                                                        <FooterStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left">
                                            <asp:TextBox ID="txtTotal" runat="server" Width="106px" Visible="False" Style="text-align: right" Enabled="false"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </asp:Panel>
        ...
        <asp:View ID="View4" runat="server">
                            <%--<asp:CheckBox ID="CheckBox1" runat="server" AutoPostBack="True" OnCheckedChanged="chkSelectAll_CheckedChanged"
                                Text="Select/Unselect All Students" />--%>
                            

            <td style="text-align: left">
                                            <asp:TextBox ID="txtAmountforStudent" runat="server" Width="106px" Visible="False" Style="text-align: right" Enabled="false"></asp:TextBox>
                                        </td>
        </asp:View>
                    ...
                    <tr>
                        <td>
                            <table>
                                <tr>
                                    <td>
                                        <asp:Label ID="Label48" runat="server" Text="Sponsor" Width="104px"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:DropDownList ID="ddlSponsor" runat="server" Height="20px" Width="314px" AppendDataBoundItems="True" Enabled="True">
                                        </asp:DropDownList>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <asp:ImageButton ID="ibtnAddStudent" runat="server" Height="21px" ImageUrl="~/images/addrec.gif"
                                                            ToolTip="Add Student" />
                                        <asp:Label ID="Label4" runat="server" Text="Add Student Manually" Width="104px"></asp:Label>
                                    </td>
                                </tr>
                                 <tr>
                                            <td>
                            ...
                            <fieldset style="width: 98%">
                                        ...
                                        <tr>
                                            <td style="width: 100%; vertical-align: top;">
                                                ...
                                                <asp:CheckBox ID="chkStudent" runat="server" OnCheckedChanged="chkStudent_CheckedChanged"
                                                    AutoPostBack="True" Text="Select All" Checked ="false" />
                                                <asp:DataGrid ID="dgStudent" runat="server" AutoGenerateColumns="False" Width="100%" OnItemDataBound="dgStudent_ItemDataBound">
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateColumn HeaderText="Select">
                                                            ...
                                                            <ItemTemplate>
                                                                &nbsp;<asp:CheckBox ID="chkProgram" runat="server" AutoPostBack="True" OnCheckedChanged="chkprogram_checkedchanged" Checked ="false" />
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                        ...
                                                        <asp:BoundColumn DataField="CreditRef" HeaderText="Sponsor Code" Visible="false"></asp:BoundColumn>
                                                        <asp:BoundColumn DataField="SponsorLimit" HeaderText="Sponsor Limit" Visible="false"></asp:BoundColumn>
                                                        <asp:BoundColumn DataField="OutstandingAmount" HeaderText="Outstanding Amount" Visible="false"></asp:BoundColumn>
                                                        <asp:BoundColumn HeaderText="Matric No" Visible="false"></asp:BoundColumn>
                                                        <asp:BoundColumn HeaderText="Student Name" Visible="false"></asp:BoundColumn>
                                         ...
                                         <asp:CheckBox ID="chkStudentall" runat="server" OnCheckedChanged="chkStudent1_CheckedChanged"
                                                    AutoPostBack="True" Text="Select All" Checked ="True" Visible ="False"/>
                                        <asp:DataGrid ID="dgstudent1" runat="server" AutoGenerateColumns="False" DataKeyField="MatricNo"
                                Width="100%" PageSize="1" OnItemDataBound="dgStudent1_ItemDataBound">
                                <FooterStyle CssClass="dgFooterStyle" Height="20px" />
                                <SelectedItemStyle CssClass="dgSelectedItemStyle" />
                                <AlternatingItemStyle BackColor="Beige" CssClass="dgAlternatingItemStyle" Font-Bold="False"
                                    Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" />
                                ...
                                <Columns>
                                   <asp:TemplateColumn HeaderText="Select">
                                                            ...
                                                            <ItemTemplate>
                                                                &nbsp;<asp:CheckBox ID="chkStudents" runat="server" AutoPostBack="True" OnCheckedChanged="chkStudents_checkedchanged" />
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                    ...
                                    <asp:BoundColumn HeaderText="Invoice Amount to Sponsor" DataField="TempAmount"></asp:BoundColumn>
                                    <asp:BoundColumn HeaderText="IC No" DataField="ICNo" Visible ="False">
                                        <HeaderStyle Width="10%" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn HeaderText="Semester" DataField="CurretSemesterYear" Visible ="False">
                                        <HeaderStyle Width="10%" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn HeaderText="Sponsor Limit" DataField="SponsorLimit" Visible ="False">
                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" HorizontalAlign="Right" />
                                        <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" VerticalAlign="Middle" Width="10%" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn HeaderText="Allocated Amount" DataField="AllocatedAmount" Visible ="False">
                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" HorizontalAlign="Right" />
                                        <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" VerticalAlign="Middle" Width="10%" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn HeaderText="Available Amount" DataField="OutstandingAmount">
                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" HorizontalAlign="Right" />
                                        <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" VerticalAlign="Middle" Width="10%" />
                                    </asp:BoundColumn>    
                                    <asp:BoundColumn HeaderText="FeeCodeForStudent" DataField="ReferenceCode" Visible ="False"></asp:BoundColumn>
