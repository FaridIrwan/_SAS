<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" AutoEventWireup="false" MaintainScrollPositionOnPostback="true"
    CodeFile="FeeType.aspx.vb" Inherits="Feetype" Title="Welcome To SAS" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <table class="fields" style="width: 100%; height: 100%;">
                            ...
                            <tr>
                                ...
                                <td class="fields" style="width: 12px; height: 25px;">
                                    <asp:DropDownList ID="ddlFeeCategory" runat="server" OnSelectedIndexChanged="ddlFeeCategory_SelectedIndexChanged" AutoPostBack="true">
                            ...
                            <tr style="display:none;" >
                                ...
                                <td class="fields" style="width: 12px; height: 25px">
                                    <asp:CheckBox ID="chkTutionFee" runat="server" Width="145px"  Enabled="false"/>
                                </td>
                                <td style="width: 218px; height: 25px">&nbsp;</td>
                                <td style="width: 100px; height: 25px">&nbsp;</td>
                            </tr>
                            <tr>
                                <td style="width: 3px; height: 25px">&nbsp;</td>
                                <td class="fields" style="width: 95px; height: 25px">
                                    <asp:Label ID="Label10" runat="server" Style="vertical-align: middle"
                                        Text="Is Change Program" Width="100px"></asp:Label>
                                </td>
                                <td class="fields" style="width: 12px; height: 25px">
                                    <asp:CheckBox ID="chkChangeProg" runat="server" Width="145px" />
                                </td>
                                <td style="width: 218px; height: 25px">&nbsp;</td>
                                <td style="width: 100px; height: 25px">&nbsp;</td>
                            </tr>
                ...
                <td class="fields" style="width: 100%; height: 16px;">&nbsp;
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="Fee Amount">
                            <ItemTemplate>
                                <asp:TextBox ID="txtFeeAmount" runat="server" Width="67px"  AutoPostBack="true" OnTextChanged="txtFeeAmount_TextChanged" Text='<%# GSTFunc2(Eval("FSAmount"), Eval("GSTAmount"))%>'></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Actual Fee Amount">
                            <ItemTemplate>
                                <asp:TextBox ID="txtActFeeAmount" runat="server" Width="67px" Enabled="false" Text='<%# GSTFunc(Eval("FSAmount"), Eval("GSTAmount"))%>'></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:BoundColumn DataField="FSAmount" HeaderText="FeeAmount" Visible="False" ></asp:BoundColumn>
                         <asp:TemplateColumn HeaderText="GST Amount">
                            <ItemTemplate>
                                <asp:TextBox ID="txtGSTAmount" runat="server" Width="67px" Enabled="false" Text='<%# Eval("GSTAmount")%>'></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                         <asp:TemplateColumn HeaderText="TotalFee Amount">
                            <ItemTemplate>
                                <asp:TextBox ID="txtTotFeeAmount" runat="server" Width="67px" Enabled="false" Text='<%# Eval("FSAmount")%>'></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                    </Columns>
                </asp:DataGrid>
    ...
    <asp:Panel ID="pnlFaculty" runat="server" Width="70%">
        <table style="width: 100%;">
            <tr>
                <td style="width: 3px; height: 16px;"></td>
                <td class="fields" style="width: 100%; height: 16px;">&nbsp;
                    <asp:DataGrid ID="dgFaculty" runat="server" AutoGenerateColumns="False" Width="100%" Style="vertical-align: top" 
                        OnItemDataBound="dgFaculty_ItemDataBound" OnItemCommand="dgFaculty_ItemCommand">
                        <FooterStyle CssClass="dgFooterStyle" Height="20px" />
                        <SelectedItemStyle CssClass="dgSelectedItemStyle" />
                        <AlternatingItemStyle BackColor="Beige" CssClass="dgAlternatingItemStyle" Font-Bold="False"
                            Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" />
                        ...
                        <HeaderStyle BackColor="#CDD7EE" CssClass="dgHeaderStyle" Font-Bold="True" Font-Italic="False"
                            Font-Overline="False" Font-Size="Medium" Font-Strikeout="False" Font-Underline="False" />
                        <Columns>
                            <asp:BoundColumn DataField="Faculty" HeaderText="Faculty" ItemStyle-Width="50%"></asp:BoundColumn>
                            <asp:TemplateColumn HeaderText="GL Account" ItemStyle-Width="40%">
                                <ItemTemplate>
                                        <asp:TextBox ID="txtGLAcc" runat="server" Width="200px" AutoPostBack="true" OnTextChanged="txtGLAcc_TextChanged"></asp:TextBox>&nbsp;
                                        <asp:Button ID="CheckGLAcc" runat="server" Text="Check" CommandName="Check"/><br />
                                        <asp:Image ID="imgGL" runat="server" ImageAlign="Baseline" ImageUrl="~/images/check.png"  />&nbsp;&nbsp;
    ...
    <asp:Panel ID="pnlKolej" runat="server" Width="70%">
        <table style="width: 100%;">
            <tr>
                <td style="width: 3px; height: 16px;"></td>
                <td class="fields" style="width: 100%; height: 16px;">&nbsp;
                    <asp:DataGrid ID="dgKolej" runat="server" AutoGenerateColumns="False" Width="100%" Style="vertical-align: top" 
                        OnItemDataBound="dgKolej_ItemDataBound" OnItemCommand="dgKolej_ItemCommand">
                        <FooterStyle CssClass="dgFooterStyle" Height="20px" />
                        <SelectedItemStyle CssClass="dgSelectedItemStyle" />
                        <AlternatingItemStyle BackColor="Beige" CssClass="dgAlternatingItemStyle" Font-Bold="False"
                            Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" />
                        ...
                        <HeaderStyle BackColor="#CDD7EE" CssClass="dgHeaderStyle" Font-Bold="True" Font-Italic="False"
                            Font-Overline="False" Font-Size="Medium" Font-Strikeout="False" Font-Underline="False" />
                        <Columns>
                            <asp:BoundColumn DataField="Kolej" HeaderText="Kolej" ItemStyle-Width="50%"></asp:BoundColumn>
                            <asp:TemplateColumn HeaderText="GL Account" ItemStyle-Width="40%">
                                <ItemTemplate>
                                        <asp:TextBox ID="txtGLAccKolej" runat="server" Width="200px" AutoPostBack="true" OnTextChanged="txtGLAccKolej_TextChanged"></asp:TextBox>&nbsp;
                                        <asp:Button ID="CheckGLAccKolej" runat="server" Text="Check" CommandName="Check"/><br />
                                        <asp:Image ID="imgGLKolej" runat="server" ImageAlign="Baseline" ImageUrl="~/images/check.png"  />&nbsp;&nbsp;
                                        <asp:Label ID="lblDesc" runat="server"></asp:Label>
                                  </ItemTemplate>
                            </asp:TemplateColumn>
                        </Columns>
