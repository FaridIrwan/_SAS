<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" AutoEventWireup="false"
    CodeFile="FeePosting.aspx.vb" Inherits="FeePosting" Title="Welcome To SAS" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function getpostconfirm() {
            ...
            {
                //modified by Hafiz @ 23/02/2017
                document.getElementById("<%=GLflagTrigger.ClientID%>").value = "ON";

                PageMethods.CheckGL(document.getElementById("<%=txtBatchNo.ClientID%>").value, "AFC",
                function (response) {
                    onSuccess(response);
    ...
    <asp:Panel ID="Panel1" runat="server" Width="100%" style="margin-left: 0px">
        <table style="background-image: url(images/Sample.png);">
            <tr>
                <td style="width: 4px; height: 14px"></td>
                <td style="width: 14px; height: 14px"></td>
                <%-- Editted By Mona @02/03/2016--%>
                ...
                <%-- Done Editted By Mona @02/03/2016--%>
                <td>
                    <table style="border-collapse: collapse;" class="menuoff" onmouseover="className='menuon';"
                        onmouseout="className='menuoff';">
                        <tr>
                ...
                <td>
                    <table style="border-collapse: collapse;" class="menuoff" onmouseover="className='menuon';"
                        ...
                        <tr>
                            <td style="width: 3%; height: 14px">
                                <asp:ImageButton ID="ibtnPrint" runat="server" ImageUrl="~/images/gprint.png" ToolTip="Print"
                                    OnClick="ibtnPrint_Click1" Enabled="False" />
                            </td>
                            <td style="width: 3%; height: 14px">
                ...
                <td style="float: left;display:None; visibility:collapse;">
                    <table style="border-collapse: collapse;" class="menuoff" onmouseover="className='menuon';"
                        ...
                        <tr>
                            ...
                            <td style="width: 3%; height: 14px">
                                <asp:Label ID="Label2" runat="server" Text="Search" Visible="false"></asp:Label>
                            </td>
                        </tr>
                    </table>
                </td>
                ...
                <td style="width: 70%; height: 215px;">
                    <fieldset>
                        ...
                        <table>
                            ...
                            <tr>
                                <td style="height: 27px; width: 3px;"><span style="color: #ff0033"></span>
                                    </td>
                                <td style="width: 11%; height: 27px">
                                    <asp:Label ID="Label3" runat="server" Text="Bidang" Width="48px"></asp:Label>
                                </td>
                                <td style="width: 387px; height: 27px; text-align: left;">
                                    <asp:DropDownList ID="ddlBidang" runat="server" AppendDataBoundItems="true" AutoPostBack="true"
                                    Width="300px">
                                </asp:DropDownList>
                                <td>
                                ...
                                <td rowspan="7" style="width: 149px">
                            ...
                            <tr>
                                ...
                                <td style="width: 387px; height: 25%; text-align: left;">
                                    <asp:DropDownList ID="ddlCurrSem" runat="server" AppendDataBoundItems="true" AutoPostBack="True" Width="300px">
                                    </asp:DropDownList>
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="width: 10px; height: 25px">
                                        <asp:TextBox ID="txtInvoiceDate" runat="server" ReadOnly="true" MaxLength="20" Width="103px" TabIndex="-1"></asp:TextBox>
                                </td>
                            ...
                            <tr>
                                <td style="height: 25px; width: 3px;">
                                    <span style="color: #ff0000"></span> </td>
                                <td style="width: 11%; height: 25px">
                                    <asp:Label ID="lblSemester" runat="server" Text="Semester" Width="67px" Visible="false"></asp:Label>
                                </td>
                                <td style="width: 387px; height: 25%; text-align: left;">
                                    <asp:DropDownList ID="ddlSemester" runat="server" AppendDataBoundItems="true" AutoPostBack="True" Visible="false"></asp:DropDownList>
                                </td>
                                <td style="height: 25px;">
                                    <span style="color: #ff0000">*</span>
                                </td>
                                ...
                                <td style="width: 10px; height: 25px">
                                        <asp:TextBox ID="txtDueDate" runat="server" MaxLength="20" Width="103px"></asp:TextBox>
                                </td>
                                <td style="width: 46px; height: 25px">
                            ...
                            <tr>
                                ...
                                <td style="width: 11%; height: 27px">
                                    <asp:Label ID="Label28" runat="server" Text="Faculty" Width="48px" Visible="false"></asp:Label>
                                </td>
                                <td style="width: 387px; height: 27px; text-align: left;">
                                    <asp:DropDownList ID="ddlFaculty" runat="server" AppendDataBoundItems="True" AutoPostBack="True" DataValueField=" " Height="20px" Width="302px" Visible="false">
                                        <asp:ListItem Value="-1">--Select--</asp:ListItem>
                            ...
                            <tr>
                                ...
                                <td style="width: 11%; height: 13px">
                                    <asp:Label ID="lblProgram" runat="server" Text="Program" Width="48px" Visible="false"></asp:Label>
                                </td>
                                <td style="width: 387px; height: 13px; ">
                                    <asp:DropDownList ID="ddlProgramInfo" runat="server" AppendDataBoundItems="true" AutoPostBack="True" Width="300px" Visible="false">
                                    </asp:DropDownList>
                                </td>
                                <td style="height: 25px;"></td>
                                <td style="height: 25px;"></td>
                            ...
                            <tr>
                                <td style="height: 25px; width: 3px;"></td>
                                <td style="width: 11%; height: 13px">
                                    <asp:Label ID="Label27" runat="server" Text="Fee Posted For" Width="79px" Visible="false"></asp:Label></td>
                                <td style="width: 387px; height: 13px; ">
                                   <table>
                                        <tr>
                                            <td style="width: 124px; height: 22px; display: inline;">
                                                <asp:RadioButton ID="rbSemester" runat="server" AutoPostBack="true" ForeColor="Black" GroupName="PostedFor" Height="22px" Text="Semester" Width="115px" Visible="false" />
                                            </td>
                                            <td style="width: 144px; height: 22px; text-align: left;">
                                                <asp:RadioButton ID="rbAnnual" runat="server" AutoPostBack="true" ForeColor="Black" GroupName="PostedFor" Style="margin-left: 0px" Text="Annual" Width="62px" Visible="false" />
                                            </td>
                                        </tr>
                                    </table></td>
                                <td style="height: 25px;"></td>
        ...
        <table style="width: 100%">
            <tr>
                <td colspan="4" style="vertical-align: top; height: 206px">
                    <asp:GridView ID="dgView" runat="server" AutoGenerateColumns="False" Width="100%" AllowPaging="True" >
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ProgramId" HeaderText="Program Code">
                                <HeaderStyle Width="12%" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="Program" HeaderText="Program Name"></asp:BoundField>
                            <asp:BoundField HeaderText="Post Status" Visible="False"> 
                                <HeaderStyle Width="10%" />
                            </asp:BoundField>
                            <asp:BoundField DataField="Faculty" HeaderText="Faculty"></asp:BoundField>
                            <asp:BoundField DataField="Semester" HeaderText="Intake Semester" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center"></asp:BoundField>
                            <asp:BoundField DataField="BatchNo" HeaderText="Batch Number" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center"></asp:BoundField>
                            <asp:BoundField DataField="TransStatus" HeaderText="Status" ></asp:BoundField>
                            ...
                            <asp:BoundField DataField="BidangCode" HeaderText="Bidang Code" ></asp:BoundField>
                            <asp:BoundField DataField="CurrentSemester" HeaderText="Current Semester" ></asp:BoundField>
                        </Columns>
                    </asp:GridView>&nbsp;
                </td>
            </tr>
