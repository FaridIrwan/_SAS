                                ...
                                <div style="overflow: auto; width: 700px; height: 200px;">
                                    <asp:DataGrid ID="dgView" runat="server" AutoGenerateColumns="False" DataKeyField="FeeTypeCode"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundColumn DataField="LocalAmount" HeaderText ="Fee Amount (Local)" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                            <asp:BoundColumn DataField="NonLocalAmount" HeaderText ="Fee Amount (International)" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
