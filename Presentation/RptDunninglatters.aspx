<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" AutoEventWireup="false"
    CodeFile="RptDunninglatters.aspx.vb" Inherits="RptDunninglatters" Title="Welcome To SAS" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        //{           
        //           //new_window= window.open('RptTransactionDetailCRFormFinal.aspx?fdate='+ fromdate1 + '&tdate='+todate1 ,'SAS','width=700,height=500,resizable=1');  new_window.focus();           
        //             alert("Do not leave empty code TextBox");
        //           return false;
        //      }
        //else
        //      {        
        ...
        //           window.open('RptDunninglattersCRFormFinal.aspx?codeid='+ code,'SAS','width=700,height=500,resizable=1');
        //           return true;
        //          }   
        //      }
        //}
    ...
    <fieldset style="width: 99%; border: thin solid #A6D9F4;">
        ...
        <table style="width: 100%">
           ...
           <%-- <tr>
                <td colspan="2">
                    <asp:Label ID="Bank Profile No" runat="server" Text="Nombor Akaun"></asp:Label>
                </td>
                <td colspan="2" class="auto-style1"><asp:DropDownList ID="ddl_bankac" AppendDataBoundItems="true" runat="server" Height="25px" Width="127px">
                    </asp:DropDownList></td>
            ...
            <tr>
                ...
                <td colspan="2" style="height: 16px">
                    <asp:TextBox ID="txtSignBy" runat="server" Width="519px" MaxLength="60"></asp:TextBox>
                </td>
                <td style="width: 1650px; height: 16px">
                    <span style="color: #ff0000"></span>
                </td>
            ...
            <tr>
                ...
                <td colspan="2" style="height: 16px">
                    <asp:TextBox ID="txtName" runat="server" Width="519px" MaxLength="50"></asp:TextBox>
                </td>
                <td style="width: 1650px; height: 16px">
                    <span style="color: #ff0000"></span>
                </td>
