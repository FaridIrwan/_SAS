...
Partial Class Block
    ...
    Dim CFlag As String
    Dim DFlag As String
    Dim ListObjects As List(Of BlockEn)
...
#Region "Methods"
    ...
    Private Sub LoadUserRights()
        ...
        Catch ex As Exception
            LogError.Log("Block", "LoadUserRights", ex.Message)
        End Try
        'Rights for Add
    ...
    ''' <summary>
    ''' Method to Save and Update Block
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub OnSave()
        Dim bsobj As New BlockBAL
        Dim eobj As New BlockEn
        Dim RecAff As Integer

        eobj.SABK_Code = Trim(txtBlockCode.Text)
        eobj.SABK_Description = Trim(txtBlockDesc.Text)
        ...
        If Session("PageMode") = "Add" Then
            ...
            Catch ex As Exception
                ...
                LogError.Log("Block", "OnSave", ex.Message)
            End Try
        ElseIf Session("PageMode") = "Edit" Then
            ...
            Catch ex As Exception
                lblMsg.Text = ex.Message.ToString
                If lblMsg.Text = "Record Already Exist" Then
                    OnEdit()
                Else
                    LogError.Log("Block", "OnSave", ex.Message)
                End If
    ...
    End Sub
    ''' <summary>
    ''' Method to Delete Block
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub OnDelete()
        lblMsg.Visible = True
        If txtBlockCode.Text <> "" Then
            ...
            If lblCount.Text > 0 Then
                ...
                Dim RecAff As Integer
                lblMsg.Visible = True
                eobj.SABK_Code = txtBlockCode.Text
                Try
                ...
                Catch ex As Exception
                    lblMsg.Text = ex.Message.ToString()
                    LogError.Log("Block", "OnDelete", ex.Message)
                End Try
                txtBlockCode.Text = ""
                txtBlockDesc.Text = ""
                ddlKolej.SelectedValue = "-1"
    ...
    End Sub
    ''' <summary>
    ''' Method to Get List of Block and Load
    ''' </summary>
    ''' <remarks></remarks>
    Public Sub LoadListObjects()
        Dim eob As New BlockEn
        Dim bobj As New BlockBAL


        If txtBlockCode.Text = "" Then txtBlockCode.Text = "*"
        eob.SABK_Code = Trim(txtBlockCode.Text)
        eob.SABK_Description = Trim(txtBlockDesc.Text)
        If ddlKolej.SelectedValue = "-1" Then
            eob.SAKO_Code = "*"
        Else
        ...
        End If
        Try
            ListObjects = bobj.GetBlockListall(eob)
        Catch ex As Exception
            LogError.Log("Block", "LoadListObjects", ex.Message)
        End Try
        Session("ListObj") = ListObjects
    ...
    Private Sub FillData(ByVal RecNo As Integer)
        ...
        Else
            ...
            txtBlockCode.Text = obj.SABK_Code
            txtBlockDesc.Text = obj.SABK_Description
    ...
    Private Sub Menuname(ByVal MenuId As Integer)
        ...
        Catch ex As Exception
            LogError.Log("Block", "Menuname", ex.Message)
        End Try
