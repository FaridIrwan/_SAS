...
Partial Class StudentCategory
    ...
    Dim CFlag As String
    Dim DFlag As String
    Dim ListObjects As List(Of StudentCategoryEn)
...
#Region "Methods"
    ...
    Private Sub SpaceValidation()
        If Trim(txtCategoryName.Text).Length = 0 Then
            ...
            lblMsg.Text = "Enter valid Student Category Description"
            lblMsg.Visible = True
    ...
    Private Sub LoadUserRights()
        ...
        Catch ex As Exception
            LogError.Log("StudentCategory", "LoadUserRights", ex.Message)
        End Try
        'Rights for Add
    ...
    Private Sub OnSave()
        ...
        If Session("PageMode") = "Add" Then
            ...
            Catch ex As Exception
                ...
                LogError.Log("StudentCategory", "OnSave", ex.Message)
            End Try
    ...
    Private Sub OnDelete()
        If txtCategoryCode.Text <> "" Then
            ...
            If lblCount.Text > 0 Then
                ...
                Dim eobj As New StudentCategoryEn
                Dim RecAff As Integer
                eobj.StudentCategoryCode = txtCategoryCode.Text
                ...
                Catch ex As Exception
                    lblMsg.Text = ex.Message.ToString()
                    LogError.Log("StudentCategory", "OnDelete", ex.Message)
                End Try
    ...
    Public Sub LoadListObjects()
        ...
        Try
            ListObjects = bobj.GetStudentCategoryList(eobj)
        Catch ex As Exception
            LogError.Log("StudentCategory", "LoadListObjects", ex.Message)
        End Try
    ...
    Private Sub FillData(ByVal RecNo As Integer)
        ...
        Else
            ...
            Else
                PnlView.Visible = False
                PnlAdd.Visible = True
                Dim obj As StudentCategoryEn
                ListObjects = Session("ListObj")
                obj = ListObjects(RecNo)

                txtCategoryCode.Text = obj.StudentCategoryCode
    ...
    Private Sub Menuname(ByVal MenuId As Integer)
        ...
        Catch ex As Exception
            LogError.Log("StudentCategory", "Menuname", ex.Message)
        End Try
