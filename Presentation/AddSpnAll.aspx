...
<head runat="server">
    <title>Welcome To SAS Page</title>
    ...
    <div style="text-align: left; background-color: white;">
        <table style="width: 400px">
            ...
            <asp:DataGrid ID="dgView" runat="server" AutoGenerateColumns="False" DataKeyField="TransactionCode"
                ...
                <Columns>
                    <asp:ButtonColumn CommandName="Select" DataTextField="TranssactionID" HeaderText="Code"
                    ...
                    <asp:BoundColumn DataField="TranssactionID" HeaderText="TranssactionID" Visible="False"></asp:BoundColumn>
                </Columns>
            </asp:DataGrid></div> </td>
            </tr>
            <tr>
