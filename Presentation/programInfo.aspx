<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="false" 
    CodeFile="programInfo.aspx.vb" Inherits="programinfo" Title="Welcome To SAS" %>
            ...
            <tr>
                ...
                <td style="float: left;display:None; visibility:collapse;">
                    <table style="border-collapse: collapse;" class="menuoff" onmouseover="className='menuon';" onmouseout="className='menuoff';">
                        <tr>
                            <td>
                                <asp:ImageButton ID="ibtnPosting" runat="server" ImageUrl="~/images/gposting.png" ToolTip="Cancel" Visible="false"/></td>
                            <td>
                                <asp:Label ID="Label6" runat="server" Text="Posting" Visible="false"></asp:Label></td>
                        </tr>
                    </table>
                </td>
                    ...
                    <div style="border: thin solid #A6D9F4; width: 100%">
                        <table class="fields" style="width: 100%; height: 100%;">
                            ...
                            <tr>
                                <td style="width: 3px; height: 25px"><span style="font-size: 11pt; color: #ff0066; font-family: Arial">*</span></td>
                                <td class="fields" style="width: 58px; height: 25px">
                                    <asp:Label ID="Label19" runat="server" Style="vertical-align: middle" Text="Bidang"
                                        Width="78px"></asp:Label></td>
                                <td class="fields" style="width: 27px; height: 25px">
                                    <asp:DropDownList ID="ddlBidang" AppendDataBoundItems="True" runat="server" Width="147px" />
                                </td>
                                <td style="width: 314px; height: 25px"></td>
                                <td style="width: 80px; height: 25px"></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="fields" style="width: 27px; height: 25px">
                                    <span style="font-size: 11pt; font-family: Arial">
                                        <asp:TextBox ID="txtFacultyDesc" runat="server" MaxLength="50" Width="345px" ReadOnly="true"></asp:TextBox></span> <span style="font-size: 11pt; color: #ff0066">
                            ...
                            <tr>
                                ...
                                <td class="fields" style="width: 27px; height: 25px">
                                    <asp:TextBox ID="txtShortName" runat="server" Width="142px" MaxLength="50" ReadOnly="true"></asp:TextBox></td>
                                <td style="width: 314px; height: 25px"></td>
                                <td style="width: 80px; height: 25px"></td>
                            </tr>
                            <tr>
