<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="false" CodeFile="UserRights.aspx.vb" Inherits="UserRights" Title="Welcome To SAS" %>
        ...
        <table style="background-image: url(images/Sample.png);">
            <tr>
               ...
               <%-- Editted By Zoya @24/02/2016--%>
                ...
                <td style="float: left; display:None; visibility:collapse;width: 2%; height: 14px">
                    <asp:Label ID="lblCount" runat="server" Width="20px" Visible="false"></asp:Label></td>
                <td style="float: left; display:None; visibility:collapse;width: 2%; height: 14px">
                ...
                <%--Done Editted By Zoya @3/03/2016--%>
