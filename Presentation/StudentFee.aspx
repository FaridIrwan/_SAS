<%@ Page Language="VB" AutoEventWireup="false" CodeFile="StudentFee.aspx.vb" MaintainScrollPositionOnPostback="true"
    Inherits="StudentFee" %>
                    ...
                    <table style="width: 418px; height: 57px">
                        ...
                        <tr>
                            <td style="width: 78px; height: 22px;">
                                <asp:Label ID="Label6" runat="server" Text="Student Category" Width="87px" Visible="false"></asp:Label>
                            </td>
                            <td style="width: 100px; height: 22px;">
                                <asp:DropDownList ID="ddlStudentCategory" runat="server" Width="110px" Visible="false">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 100px; height: 123px">
                                <div style="overflow: auto; width: 700px; height: 200px;">
                                    <asp:DataGrid ID="dgView" runat="server" AutoGenerateColumns="False" DataKeyField="FeeTypeCode"
                                        Width="500px" Height="46px" Style="vertical-align: top">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:ButtonColumn CommandName="Select" DataTextField="FeeTypeCode" HeaderText="Fee Code"
                                                Text="FeeTypeCode" ItemStyle-HorizontalAlign="Center"></asp:ButtonColumn>
                                            <asp:BoundColumn DataField="Description" HeaderText="Fee Desc"></asp:BoundColumn>
                                            <%--<asp:BoundColumn DataField="SCCode" HeaderText="Student Category"></asp:BoundColumn>--%>
                                            <%--<asp:BoundColumn DataField="FSAmount" HeaderText="Fee Amount" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>--%>
                                            <asp:TemplateColumn HeaderText="Amount(Local)">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtFeelocal" runat="server" Width="98px" AutoPostBack="True" OnTextChanged="txtFeeLocal_TextChanged"
                                            ...
                                            <asp:BoundColumn DataField="LocalAmount" HeaderText ="Fee Amount (Local)" ItemStyle-HorizontalAlign="Center" Visible ="false"></asp:BoundColumn>
                                             <asp:TemplateColumn HeaderText="Amount(Int)">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtFeeint" runat="server" Width="98px" AutoPostBack="True" OnTextChanged="txtFeeINt_TextChanged"
                                                                  Style="text-align: right" Height="18px" MaxLength="10"></asp:TextBox>
                                            ...
                                            <asp:BoundColumn DataField="NonLocalAmount" HeaderText ="Fee Amount (International)" ItemStyle-HorizontalAlign="Center" Visible ="false"></asp:BoundColumn>
                                            <asp:BoundColumn DataField="Priority" HeaderText="Priority" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>                                            
                                            <asp:BoundColumn DataField="TaxId" HeaderText="TaxId" Visible="false"></asp:BoundColumn>
                                            <asp:BoundColumn DataField="GSTAmount" HeaderText="GstAmount" Visible="false"></asp:BoundColumn>
                                            <asp:BoundColumn DataField="LocalGSTAmount" HeaderText ="GST Amount (Local)" Visible="false"></asp:BoundColumn>
                                            <asp:BoundColumn DataField="NonLocalGSTAmount" HeaderText ="GST Amount (International)" Visible="false"></asp:BoundColumn>
                                            <asp:BoundColumn DataField="NonLocalCategory" HeaderText ="Category (International)" Visible="false"></asp:BoundColumn>
                                            <asp:BoundColumn DataField="LocalCategory" HeaderText ="Category (Local)" Visible="false"></asp:BoundColumn>
                                        </Columns>
                                    </asp:DataGrid></div>
                            </td>
                        </tr>
