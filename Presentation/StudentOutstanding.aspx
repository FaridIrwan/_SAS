            ...
            <table width="60%">
                ...
                <tr>
                    ...
                    <td colspan="2" align="left">
                        ...
                        &nbsp;&nbsp;<asp:CheckBox ID="chkExcludeLoan" Text="Exclude Loan" runat="server" />
                        &nbsp;&nbsp;
                        <%-- added by Hafiz Roslan @ 5/2/2016 --%>
                        <%-- current semester checkbox will be add -START --%>
                        <%-- Updated by Hafiz @ 26/2/2016 --%>
                        &nbsp;&nbsp;<asp:CheckBox ID="chkExcludeCurSem" Text="Exclude Cur. Sem." runat="server" />
                        &nbsp;&nbsp;
                        <%-- current semester checkbox will be add -END --%>
                ...
                <tr style="height: 30px"></tr>
                 <tr>
                    ...
                    <td>
                        ...
                        <asp:Label ID="lblFileUpload" runat="server" Text="" Visible="False" />
