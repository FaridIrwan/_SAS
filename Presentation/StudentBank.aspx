<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" AutoEventWireup="false" MaintainScrollPositionOnPostback="true"
    CodeFile="StudentBank.aspx.vb" Inherits="StudentBank" Title="Welcome To SAS" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validate() {
            ...
            if (document.getElementById("<%=TxtBankCode.ClientID%>").value.replace(re, "$1").length == 0) {
                alert("Student Bank Code Field Cannot Be Blank");
            ...
            for (var i = 0; i < document.getElementById("<%=TxtBankCode.ClientID%>").value.length; i++) {
                ...
                if (digits.indexOf(temp) == -1) {
                    alert("Enter Valid Student Bank Code");
                    document.getElementById("<%=TxtBankCode.ClientID%>").focus();
                    return false;
                }
            }
            if (document.getElementById("<%=txtBankDescription.ClientID%>").value.replace(re, "$1").length == 0) {
                alert("Student Bank Description Field Cannot Be Blank");
        ...
        <table class="mainbg" style="width: 100%;">
            <tr>
                ...
                <td class="pagetext" style="height: 39px" align="right">
                    <asp:Label ID="lblMenuName" runat="server" Text="Student Bank" Width="350px"></asp:Label>
                </td>
            </tr>
        </table>
    </asp:Panel>
                        ...
                        <table class="fields" style="width: 100%; height: 100%;">
                            ...
                            <tr>
                                ...
                                <td class="fields" style="width: 68px; height: 26px">
                                    ...
                                    <asp:Label ID="Label1" runat="server" Text="Bank Code" Width="97px"></asp:Label>
                                </td>
                                <td style="width: 43px; height: 26px">
                                    <asp:TextBox ID="TxtBankCode" runat="server" Width="142px" MaxLength="20"></asp:TextBox>
                                </td>
                                <td style="width: 100px; height: 26px">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="fields" style="width: 68px; height: 21px">
                                    <span style="font-size: 11pt; color: #ff0066">*</span>
                                    <asp:Label ID="Label2" runat="server" Text="Bank Description" Width="131px"></asp:Label>
                                </td>
                                <td style="width: 43px; height: 21px">
                                    <asp:TextBox ID="txtBankDescription" runat="server" Width="346px" MaxLength="50"></asp:TextBox>
                                </td>
