<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" AutoEventWireup="false"
    CodeFile="AFC.aspx.vb" Inherits="AFC" Title="Process-Automated Fee Charging (AFC)" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function WaitingProcess() {
            ...
            var Program = document.getElementById("<%=ddlProgram.ClientID%>").value;
        ...
        function CheckInvDate() {
            ...
            var temp;
            for (var i = 0; i < document.getElementById("<%=txtTransantionDate.ClientID %>").value.length; i++) {
                temp = document.getElementById("<%=txtTransantionDate.ClientID%>").value.substring(i, i + 1);
                if (digits.indexOf(temp) == -1) {
                    alert("Enter Valid Date (dd/mm/yyyy)");
                    document.getElementById("<%=txtTransantionDate.ClientID%>").value = "";
                    document.getElementById("<%=txtTransantionDate.ClientID%>").focus();
                    return false;
                }
            }
            return true;
        ...
        function validate() {
            ...
            if (document.getElementById("<%=txtTransantionDate.ClientID%>").value.replace(re, "$1").length == 0) {
            ...
            //txtTransantionDate---------------------------------------------------------------------------
            var len = document.getElementById("<%=txtTransantionDate.ClientID%>").value
            var RegExPattern = /^((((0?[1-9]|[12]\d|3[01])[\.\-\/](0?[13578]|1[02])[\.\-\/]((1[6-9]|[2-9]\d)?\d{2}))|((0?[1-9]|[12]\d|30)[\.\-\/](0?[13456789]|1[012])[\.\-\/]((1[6-9]|[2-9]\d)?\d{2}))|((0?[1-9]|1\d|2[0-8])[\.\-\/]0?2[\.\-\/]((1[6-9]|[2-9]\d)?\d{2}))|(29[\.\-\/]0?2[\.\-\/]((1[6-9]|[2-9]\d)?(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00)|00)))|(((0[1-9]|[12]\d|3[01])(0[13578]|1[02])((1[6-9]|[2-9]\d)?\d{2}))|((0[1-9]|[12]\d|30)(0[13456789]|1[012])((1[6-9]|[2-9]\d)?\d{2}))|((0[1-9]|1\d|2[0-8])02((1[6-9]|[2-9]\d)?\d{2}))|(2902((1[6-9]|[2-9]\d)?(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00)|00))))$/;
            var errorMessage = 'Enter Valid Date (dd/mm/yyyy)';

            if (document.getElementById("<%=txtTransantionDate.ClientID%>").value.match(RegExPattern)) {
                if (len.length == 8) {
                    alert(errorMessage);
                    document.getElementById("<%=txtTransantionDate.ClientID%>").value = "";
                    document.getElementById("<%=txtTransantionDate.ClientID%>").focus();
            ...
            var str1 = document.getElementById("<%=txtTransantionDate.ClientID %>").value;
            var str2 = document.getElementById("<%=today.ClientID %>").value;
            var dt1 = parseInt(str1.substring(0, 2), 10);
            var mon1 = parseInt(str1.substring(3, 5), 10);
            var yr1 = parseInt(str1.substring(6, 10), 10);
        ...
        function getDate1from() {
            popUpCalendar(document.getElementById("<%=ibtnInDate.ClientID%>"), document.getElementById("<%=txtTransantionDate.ClientID%>"), 'dd/mm/yyyy')
            ...
            <tr>
                ...
                <td>
                    <table style="border-collapse: collapse;" class="menuoff" onmouseover="className='menuon';"
                        ...
                        <tr>
                            <td style="width: 3%; height: 14px">
                                <asp:ImageButton ID="ibtnPost" runat="server" ImageUrl="~/images/gposting.png"
                                    ToolTip="Cancel" />
                            </td>
        ...
        <table class="mainbg" style="width: 100%">
            <tr>
                ...
                <td class="pagetext" style="height: 39px; text-align: right">
                    <asp:Label ID="lblMenuName" runat="server" Text="University Fund" Width="496px" Height="33px"></asp:Label>
                </td>
            </tr>
        </table>
        <asp:Label ID="lblMsg" runat="server" CssClass="lblError" Style="text-align: center" Width="276px"></asp:Label>
    </asp:Panel>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td style="width: 387px; height: 13px">
                                    <asp:DropDownList ID="ddlProgram" AppendDataBoundItems="true" runat="server"
                            ...
                            <tr>
                                ...
                                <td style="width: 10px; height: 25px">
                                    <span style="color: #ff0000">
                                        <asp:TextBox ID="txtTransantionDate" runat="server" ReadOnly="true" MaxLength="20" Width="103px" TabIndex="-1"></asp:TextBox></span>
                                    &nbsp;
                                </td>
