                ...
                <td style="float: left;display:None; visibility:collapse;">
                    <table style="border-collapse: collapse;" class="menuoff" onmouseover="className='menuon';"
                        ...
                        <tr id="trPrint" runat="server">
                            <td>
                                <asp:ImageButton ID="ibtnPrint" Enabled="false" runat="server" ImageUrl="~/images/gprint.png" ToolTip="Print" Visible="false"/>
                            </td>
                            <td>
    ...
    <asp:Panel ID="pnlBody" runat="server">
        <table style="width: 100%">            
            <tr>
                <td colspan="2" style="padding-left: 20px">
                    <asp:Label ID="lblMesg" runat="server" ForeColor="Blue" Visible="False" CssClass="lblError1"></asp:Label>
                </td>
            </tr>            
            <tr>
                <td colspan="2" style="padding-left: 20px">
                    <asp:Label ID="lblMesgUnSent" runat="server" ForeColor="Red" Visible="False" CssClass="lblError1"></asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="2" style="padding-left: 20px">
                    <asp:Label ID="lblMesgSent" runat="server" ForeColor="Blue" Visible="False" CssClass="lblError1"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="width: 1px; height: 16px">
                </td>
                <%-- Editted By Mona @17/03/2016--%>
                <%-- <td style="display: None; visibility: collapse;">--%>
                <td style="width: 100%; height: 16px">
                    <div style="width: 100%">
                        ...
                        <asp:Panel ID="pnlExisting" Width="100%" runat="server" Visible="false">
        ...
        <fieldset style="width: 99.5%">
            ...
            <table width="60%">
                    ...
                    <td style="width: 103px">
                        <asp:Label ID="NomborAkaun" runat="server" Text="Nombor Akaun"></asp:Label>
                    </td>
                    <td style="width: 404px">
                        <asp:DropDownList ID="ddl_bankac" AppendDataBoundItems="true" runat="server" 
                            Width="400px">
                        </asp:DropDownList>
                    </td>
                    <td>
        ...
        <asp:DataGrid ID="dgStudent" runat="server" AutoGenerateColumns="False" Width="100%">
            ...
            <Columns>
                ...
                <asp:BoundColumn DataField="SASI_Add3" Visible="false"></asp:BoundColumn>
