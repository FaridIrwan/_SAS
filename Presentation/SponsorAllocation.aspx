...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function getpostconfirm() {
            ...
            PageMethods.CheckGL(document.getElementById("<%=txtReceipNo.ClientID%>").value, "Allocation",
                function (response) {
                    onSuccess(response);
                    ...
                    if (response == true) {
                        ...
                        new_window = window.open('GLFailedList.aspx?MenuId=' + document.getElementById("<%=MenuId.ClientID%>").value + '&Batchcode=' + document.getElementById("<%=txtReceipNo.ClientID%>").value, 'Hanodale', 'width=500,height=400,resizable=0'); new_window.focus();
                            return false;
                        }
                }, onFailure);
        }
        ...
        <table class="mainbg" style="width: 100%;">
            <tr>
                ...
                <td class="pagetext" style="height: 39px; text-align: right;">
                    <asp:Label ID="lblMenuName" runat="server" Text="University Fund" Width="309px"></asp:Label>
                </td>
            </tr>
        </table>
                        ...
                        <table style="width: 464px">
                            ...
                            <tr>
                                ...
                                <td style="width: 1209px; height: 27px; text-align: left">
                                    ...
                                    <asp:Image ID="ibtnSpn1" runat="server" Height="20px" ImageUrl="~/images/find_img.png" Width="21px" />
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="1" style="width: 27px; height: 25px;">
                                    <asp:TextBox ID="txtBDate" runat="server" MaxLength="10" Style="text-align: left" Width="104px"></asp:TextBox>
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="width: 1209px; height: 25%; text-align: left">
                                    <asp:TextBox ID="txtspnAmount" runat="server" MaxLength="20" Width="142px" Style="text-align: right"></asp:TextBox>
                                 </td>
                                ...
                                <td style="width: 1266px; height: 25px">
                                    <asp:Label ID="Label19" runat="server" Text="Allocated Amount Used" Width="97px"></asp:Label>
                                </td>
                                <td style="width: 27px; height: 25px;">
                                    
                                      <asp:TextBox ID="txtspnAllAmount" runat="server" MaxLength="20" Width="142px" Style="text-align: right" visible="True"></asp:TextBox>
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="width: 1209px; text-align: left; height: 25px;">
                                    <span style="color: #ff0000"><asp:DropDownList ID="ddlBankCode" runat="server"
                                        AppendDataBoundItems="True" TabIndex="11" Width="149px">
                            ...
                            <tr>
                                ...
                                <td colspan="1" style="width: 6448px; height: 25px">
                                    <asp:Image ID="imgbankCode" runat="server" Height="20px" ImageUrl="~/images/find_img.png"
                                        Width="21px" Visible="False" />
                                </td>
                                <td style="width: 6642px; height: 25px;">
                                ...
                                <asp:Label ID="LabelAvailable" runat="server" Text="Available Amount" Width="97px"></asp:Label>
                                </td>
                                <td colspan="1" style="width: 27px; height: 26px;">
                                    <span style="color: #ff0000">
                                    <asp:TextBox ID="txtAllAmount" runat="server" MaxLength="20" Width="103px" Style="text-align: right"></asp:TextBox></span> 
                                  </td>
                            ...
                            <tr>
                                ...
                                <td style="width: 13%; height: 25px;">
                                   <asp:Label ID="Label12" runat="server" Text="File Upload" Width="97px" Visible ="False"></asp:Label>
                                </td>
                                <td style="width: 34px; height: 25px;">
                                </td>
                                <td style="width: 1209px; height: 25px;">
                                ...
                                <asp:Label ID="Label8" runat="server" Text="Total Amount" Width="97px"></asp:Label>
                                </td>
                                <td colspan="1" style="width: 27px; height: 26px;">
                                   <span style="color: #ff0000">
                            ...
                            <tr>
                                ...
                                <td style="height: 26px; width: 1209px;"></td>
                                ...
                                <td colspan="1" style="width: 6642px; height: 26px;">
                                    ...
                                    <asp:Imagebutton ID="IdtnStud" runat="server" Height="20px" 
                            ...
                            <tr>
                                ...
                                <td colspan="1" style="width: 1266px; height: 27px">
                                    ...
                                    <asp:TextBox ID="txtbatchspcode" runat="server" Visible="False"></asp:TextBox>
                                </td>
