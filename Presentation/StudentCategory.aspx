<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" AutoEventWireup="false" MaintainScrollPositionOnPostback="true"
    CodeFile="StudentCategory.aspx.vb" Inherits="StudentCategory" Title="Welcome To SAS" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validate() {
            ...
            if (document.getElementById("<%=txtCategoryCode.ClientID%>").value.replace(re, "$1").length == 0) {
                alert("Student Category Code Field Cannot Be Blank");
            ...
            for (var i = 0; i < document.getElementById("<%=txtCategoryCode.ClientID %>").value.length; i++) {
                ...
                if (digits.indexOf(temp) == -1) {
                    alert("Enter Valid Student Category Code");
                    document.getElementById("<%=txtCategoryCode.ClientID%>").focus();
                    return false;
                }
            }
            if (document.getElementById("<%=txtCategoryName.ClientID%>").value.replace(re, "$1").length == 0) {
                alert("Student Category Description Field Cannot Be Blank");
                        ...
                        <table class="fields" style="width: 100%; height: 100%;">
                            ...
                            <tr>
                                ...
                                <td class="fields" style="width: 68px; height: 26px">
                                    ...
                                    <asp:Label ID="Label1" runat="server" Text="Category Code" Width="97px"></asp:Label>
                                </td>
                                <td style="width: 43px; height: 26px">
                                    <asp:TextBox ID="txtCategoryCode" runat="server" Width="142px" MaxLength="20"></asp:TextBox>
                                </td>
                                <td style="width: 100px; height: 26px">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="fields" style="width: 68px; height: 21px">
                                    <span style="font-size: 11pt; color: #ff0066">*</span>
                                    <asp:Label ID="Label2" runat="server" Text="Category Description" Width="131px"></asp:Label>
                                </td>
                                <td style="width: 43px; height: 21px">
                                    <asp:TextBox ID="txtCategoryName" runat="server" Width="346px" MaxLength="50"></asp:TextBox>
                                </td>
