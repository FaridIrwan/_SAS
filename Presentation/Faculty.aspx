<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" AutoEventWireup="false" MaintainScrollPositionOnPostback="true"
    CodeFile="Faculty.aspx.vb" Inherits="Faculty" Title="Welcome To SAS" %>
            ...
            <table class="fields" style="width: 100%; height: 100%; text-align: left;">
                ...
                <tr>
                    ...
                    <td style="width: 43px; height: 26px">
                        <asp:TextBox ID="txtFacultyCode" runat="server" Width="142px" MaxLength="20"></asp:TextBox>
                    </td>
                ...
                <tr>
                    ...
                    <td style="width: 43px; height: 21px">
                        <asp:TextBox ID="txtFacultyDesc" runat="server" Width="346px" MaxLength="50"></asp:TextBox>
                    </td>
                ...
                <tr>
                    ...
                    <td style="width: 43px; height: 21px">
                        <asp:TextBox ID="txtFacultySDesc" runat="server"></asp:TextBox>
                    </td>
                    <td style="width: 100px; height: 21px">
                    </td>
                </tr>
