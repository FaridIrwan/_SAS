<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" AutoEventWireup="false" MaintainScrollPositionOnPostback="true"
    CodeFile="Student.aspx.vb" Inherits="Student" Title="Welcome To SAS" %>
        ...
        function validate() {
          ...
          <%--  if (document.getElementById("<%=ddlIntkSemester.ClientID%>").value == "-1") {
            ...
            if (document.getElementById("<%=ddlHostel.ClientID%>").value == "1") {
                ...
                if (document.getElementById("<%=txtFloorNo.ClientID%>").value == "") {
                    alert("Room Number Field Cannot Be Blank");
...
//            validate()
    ...
    <asp:Panel ID="Panel1" runat="server" Width="100%">
                        ...
                        <tr>
                            <td>
                                <asp:ImageButton ID="ibtnPrint" runat="server" ImageUrl="~/images/print.png" ToolTip="Print"
                                    Target="_blank" Width="24px" Visible="false"/>
                            </td>
                            <td>
        ...
        <asp:Label ID="lblMsg" runat="server" CssClass="lblError" Style="text-align: center"
            Width="870px"></asp:Label></asp:Panel>
                                ...
                                <table class="fields" style="width: 100%; height: 100%;">
                                    <tr>
                                        ...
                                        <td class="fields" style="height: 21px; text-align: left;" colspan="8">
                                            <br /><asp:Button ID="btnStuNotes" runat="server" Text="Notes" Enabled="False" OnClick="btnStuNotes_Click1" />
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 56px; height: 14px">
                                            <asp:DropDownList ID="ddlstudentStatus" runat="server" Width="153px" AppendDataBoundItems="True" AutoPostBack ="true"
                                                TabIndex="2">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 32px; height: 15px">
                                            <asp:DropDownList ID="ddlFaculty" runat="server" AppendDataBoundItems="True" AutoPostBack="True" OnSelectedIndexChanged ="ddlFaculty_SelectedIndexChanged"
                                    ...
                                    <tr>
                                        ...
                                        <td class="fields" style="width: 8px; height: 11px;">
                                            <asp:Label ID="Label71" runat="server" Font-Bold="False" Text="Intake Session" Width="113px"></asp:Label>
                                        </td>
                                        <td style="width: 32px; height: 11px;">
                                            <asp:DropDownList ID="ddlIntakeSession" runat="server" AppendDataBoundItems="True" TabIndex="15" Width="153px">
                                                <asp:ListItem Value="-1">--Select--</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                        ...
                                        <td class="fields" style="width: 28px; height: 11px;">
                                            <asp:Label ID="Label70" runat="server" Font-Bold="False" Text="Intake Semester" Visible="false" Width="113px"></asp:Label>
                                        </td>
                                        <td style="width: 56px; height: 11px;">
                                            <asp:DropDownList ID="ddlIntkSemester" runat="server" AppendDataBoundItems="True" AutoPostBack="True" TabIndex="15" Visible="false" Width="153px">
                                                <asp:ListItem Value="-1">--Select--</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="fields" style="width: 8px; height: 14px;">
                                            <asp:Label ID="Label9" runat="server" Font-Bold="False" Text="Student Bank" Width="113px"></asp:Label>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="fields" style="width: 28px; height: 15px">
                                            <asp:Label ID="lblKoko" runat="server" Font-Bold="False" 
                                                Style="vertical-align: middle" Text="Kolejgiat" Width="110px"></asp:Label>
                                        </td>
                                        <td style="width: 56px; height: 15px">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 32px; height: 19px;" class="fields">
                                            <asp:DropDownList ID="ddlKolej" runat="server" AppendDataBoundItems="True" Width="153px"
                                                TabIndex="17" AutoPostBack="True"  Enabled="false">
                                                <asp:ListItem Value="-1">--Select--</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="fields" style="width: 32px; height: 15px;">
                                            <asp:DropDownList ID="ddlblock" runat="server" AppendDataBoundItems="True" AutoPostBack="True"
                                                Width="153px" TabIndex="18"  Enabled="false">
                                                <asp:ListItem Value="-1">--Select--</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                        <td class="fields" style="width: 72px; height: 15px">
                                        ...
                                        <td class="fields" style="width: 28px; height: 15px">
                                            <asp:Label ID="Label24" runat="server" Font-Bold="False" Text="Intake Hostel" 
                                                Width="113px"></asp:Label>
                                        </td>
                                        <td style="width: 56px; height: 15px;">
                                            <asp:TextBox ID="txtHostel" runat="server" TabIndex="23" Width="146px"></asp:TextBox>
                                        </td>
                                        <td style="height: 15px; width: 3px;">
                                        </td>
                                        <td style="height: 15px; width: 17px;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 56px; height: 10px; vertical-align: middle;">
                                            <asp:DropDownList ID="ddlStatus" runat="server" Visible="False" Width="153px" AutoPostBack ="true">
                                                <asp:ListItem Value="-1">--Select--</asp:ListItem>
            ...
            <asp:View ID="View2" runat="server">
                <table width="100%">
                        ...
                        <td class="fields" colspan="11" style="height: 25px">
                            <asp:DataGrid ID="dgStuSponser" runat="server" AutoGenerateColumns="False" DataKeyField="Sponsor"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundColumn HeaderText="Fully Sponsored" DataField="FullySponsered" Visible=" false" ></asp:BoundColumn>
                                    <asp:BoundColumn DataField="SponsorLimit" HeaderText="Sponsor" Visible="False"></asp:BoundColumn>
                                </Columns>
                    ...
                    <tr>
                        ...
                        <td class="fields" style="width: 112px;">
                        </td>
                        <td style="width: 58px;">
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="fields" style="width: 92px; height: 16px">
                            <asp:Label ID="Label68" runat="server" Font-Bold="False" Text="Sponsor Limit" Width="113px"></asp:Label>
                        </td>                       
                        <td class="fields" style="width: 63px; height: 16px; text-align: left;">
                            <asp:TextBox ID="txtSpnLimit" runat="server" Enabled="true" TabIndex="24" Width="100px"></asp:TextBox>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="fields" style="width: 92px; height: 16px; vertical-align: top;">
                            <asp:Label ID="Label59" runat="server" Font-Bold="False" Height="17px" Text="Fully Sponsored" Visible="false"
                                Width="113px"></asp:Label>
                        </td>
                        <td style="width: 16px; height: 16px; vertical-align: top;">
                            <asp:CheckBox ID="chkSpnFeetypes1" runat="server" Height="22px" Width="85px" OnCheckedChanged="chkSpnFeetypes1_CheckedChanged"
                                AutoPostBack="True" Visible="false" Checked="true"/>
                        </td>
