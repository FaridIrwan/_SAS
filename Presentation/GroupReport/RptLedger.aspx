<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" AutoEventWireup="false"
    CodeFile="RptLedger.aspx.vb" Inherits="RptLedger" Title="Welcome To SAS" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function dllValues() {
            var fromdate1 = "0"
            var todate1 = "0"
            if (document.getElementById("<%=ddlLedgerType.ClientID %>").value == "-1") {
                alert("Select a Ledger Type")
                return true
            }

            if ((document.getElementById("<%=ddlStuStatus.ClientID%>").value == "-1") && (document.getElementById("<%=ChkDateRange.ClientID%>").checked == false)) {
            ...
            if (document.getElementById("<%=ChkDateRange.ClientID%>").checked) {
                ...
                if (document.getElementById("<%=ddlLedgerType.ClientID %>").value == "0") {
                    window.open('../GroupReport/RptLedgerStudentViewer.aspx?fdate=' + fromdate1 + '&tdate=' + todate1, 'SAS', 'width=700,height=500,resizable=1,scrollbars=1');
                    return true
                }
                else {
                    window.open('../GroupReport/RptLedgerSponsorViewer.aspx?fdate=' + fromdate1 + '&tdate=' + todate1, 'SAS', 'width=700,height=500,resizable=1,scrollbars=1');
                    return true
                }
            }
            else {
                if (document.getElementById("<%=ddlLedgerType.ClientID %>").value == "0") {
                    window.open('../GroupReport/RptLedgerStudentViewer.aspx', 'SAS', 'width=700,height=500,resizable=1,scrollbars=1');
                    return true
                }
                else {
                    window.open('../GroupReport/RptLedgerSponsorViewer.aspx', 'SAS', 'width=700,height=500,resizable=1,scrollbars=1');
                    return true
                }
            }
        }
        ...
        function dllValuesEn() {
            ...
            if (document.getElementById("<%=ChkDateRange.ClientID%>").checked) {
                ...
                if (document.getElementById("<%=ddlLedgerType.ClientID %>").value == "0") {
                    window.open('../GroupReport/RptLedgerStudentViewerEn.aspx?fdate=' + fromdate1 + '&tdate=' + todate1, 'SAS', 'width=700,height=500,resizable=1,scrollbars=1');
                    return true
                }
                else {
                    window.open('../GroupReport/RptLedgerSponsorViewerEn.aspx?fdate=' + fromdate1 + '&tdate=' + todate1, 'SAS', 'width=700,height=500,resizable=1,scrollbars=1');
                    return true
                }
            }
            else {
                if (document.getElementById("<%=ddlLedgerType.ClientID %>").value == "0") {
                    window.open('../GroupReport/RptLedgerStudentViewerEn.aspx', 'SAS', 'width=700,height=500,resizable=1,scrollbars=1');
                    return true
                }
                else {
                    window.open('../GroupReport/RptLedgerSponsorViewerEn.aspx', 'SAS', 'width=700,height=500,resizable=1,scrollbars=1');
                    return true
                }
            }
        }
        function dllValues1() {
            if (document.getElementById("<%=ChkDateRange.ClientID%>").checked)   //test
            {
                ...
                if (document.getElementById("<%=ddlLedgerType.ClientID %>").value == "-1")   //test
                {                           //test
                    window.open('../GroupReport/RptLedgerStudentViewer.aspx?fdate=' + fromdate1 + '&tdate=' + todate1, 'SAS', 'width=700,height=500,resizable=1');  //test
                    return true  //test
                }  //test
                else     //test
                {   // test
                    window.open('../GroupReport/RptLedgerSponsorViewer.aspx?fdate=' + fromdate1 + '&tdate=' + todate1, 'SAS', 'width=700,height=500,resizable=1');  //test
                    return true   //test
                }  //test          
            ...
            if (document.getElementById("<%=ddlLedgerType.ClientID %>").value == "-1") {
                window.open('../GroupReport/RptLedgerStudentViewer.aspx', 'SAS', 'width=700,height=500,resizable=1');
                return true
            }
            else {
                window.open('../GroupReport/RptLedgerSponsorViewer.aspx', 'SAS', 'width=700,height=500,resizable=1');
                return true
            }


            function dllValues2() {
                if (confirm("StudLedger or Sopnsor")) {
                    new_window = window.open('../GroupReport/RptLedgerStudentViewer.aspx', 'SAS', 'width=700,height=500,resizable=1'); new_window.focus();
                }
                else {
                    new_window = window.open('../GroupReport/RptLedgerSponsorViewer.aspx', 'SAS', 'width=700,height=500,resizable=1'); new_window.focus();
                }
            }
        }
    </script>
        ...
        <table class="mainbg" style="width: 100%;">
            <tr>
                ...
                <td align="right" class="pagetext" style="height: 39px">
                    <asp:Label ID="lblMenuName" runat="server" Text="Ledger Reports" Width="280px"></asp:Label>
                </td>
            </tr>
        </table>
    </asp:Panel>
                    ...
                    <table>
                        <tr>
                            ...
                            <td style="width: 34px; height: 16px">
                                <asp:DropDownList ID="ddlLedgerType" runat="server" Width="135px" AutoPostBack="True"
                                    OnSelectedIndexChanged="ddlLedgerType_SelectedIndexChanged">
                                    <asp:ListItem Value="-1">-- Select --</asp:ListItem>
                                    <asp:ListItem Value="0">Student</asp:ListItem>
                                    <asp:ListItem Value="1">Sponsor</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
            ...
            <td style="height: 16px">
                <fieldset style="width: 109%; border: thin solid #A6D9F4;">
                    ...
                    <table style="width: 111%">
                        <tr>
                            <td colspan="2" style="height: 16px; width: 257px;">
                                <asp:RadioButton ID="rbtnStudentID" runat="server" Height="15px" Text="Matric ID"
                                    Width="79px" AutoPostBack="True" GroupName="sortrecord" OnCheckedChanged="rbtnStudentID_CheckedChanged" />
                            </td>
                            <td style="width: 11px; height: 16px">
                            </td>
                            <td style="width: 458px; height: 16px">
                                <asp:RadioButton ID="rbtnstudname" runat="server" Text="Student Name" Width="150px"
                                    AutoPostBack="True" GroupName="sortrecord" OnCheckedChanged="rbtnstudname_CheckedChanged" />
                            </td>
                            <td style="width: 458px; height: 16px">
                            </td>
                            <td style="width: 458px; height: 16px">
                        ...
                        <tr>
                            <td colspan="2" style="height: 16px; width: 257px;">
                                <asp:RadioButton ID="rbtnSponsorID" runat="server" Height="15px" Text="Sponsor Code"
                                    Width="150px" AutoPostBack="True" GroupName="sortrecord" OnCheckedChanged="rbtnSponsorID_CheckedChanged" />
                            </td>
                            <td style="width: 11px; height: 16px">
                            </td>
                            <td style="width: 458px; height: 16px">
                                <asp:RadioButton ID="rbtnSponsorName" runat="server" Height="15px" Text="Sponsor Name"
                                    Width="150px" AutoPostBack="True" GroupName="sortrecord" OnCheckedChanged="rbtnSponsorName_CheckedChanged" />
                            </td>
                            <td style="width: 458px; height: 16px">
                            </td>
                            <td style="width: 458px; height: 16px">
