<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" AutoEventWireup="false"
    CodeFile="RptLetterToBIMB.aspx.vb" Inherits="RptLetterToBIMB" Title="Welcome To SAS" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function dllValues() {
            ...
            if (document.getElementById("<%=ddlType.ClientID%>").value == "-1") {
                ...
                if (document.getElementById("<%=txtUP.ClientID%>").value == "") {
                    alert("Please Insert U/P")
                    return false;
                }
                if (document.getElementById("<%=txtCek.ClientID%>").value == "") {
                    alert("Please Insert Cek Field")
                    return false;
                }
                if (document.getElementById("<%=txtDateCredit.ClientID%>").value == "") {
                    alert("Please Insert Credit Date")
                    return false;
                }
                if ((document.getElementById("<%=ddlStuStatus.ClientID%>").value == "-1") && (document.getElementById("<%=ChkDateRange.ClientID%>").checked == false)) {
                    if (confirm("Do you Want to Show All Records?")) {
                        ...
                        lbl = true;
                        new_window = window.open('../GroupReport/RptLetterToBIMBViewer.aspx?fdate=' + fromdate1 + '&tdate=' + todate1, 'SAS', 'width=700,height=500,resizable=1'); new_window.focus();
                        return lbl;
                    }
                    else {
        ...
        <table class="mainbg" style="width: 100%;">
            <tr>
                ...
                <td class="pagetext" style="height: 39px">
                    <asp:Label ID="lblMenuName" runat="server" Text="BIMB Letter" 
                ...
                <td style="width: 1005px; height: 16px">
                    &nbsp;<fieldset style="width: 100%;border: thin solid #A6D9F4;">
                        ...
                        <table style="width: 100%">
                            ...
                            <tr>
                                <td colspan="2" style="height: 16px">
                                    <asp:Label ID="Label50" runat="server" Text="U/P"></asp:Label>
                                    <asp:Label ID="Label53" runat="server" ForeColor="#FF3300" Text="*"></asp:Label>
                                </td>
                                <td colspan="5" style="height: 16px">
                                    <asp:TextBox ID="txtUP" runat="server" Width="269px" OnTextChanged="txtUP_TextChanged"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" style="height: 16px">
                                    <asp:Label ID="Label51" runat="server" Text="No Cek BIMB"></asp:Label>
                                    <asp:Label ID="Label54" runat="server" ForeColor="#FF3300" Text="*"></asp:Label>
                                </td>
                                <td colspan="5" style="height: 16px">
                                    <asp:TextBox ID="txtCek" runat="server" Width="269px" OnTextChanged="txtCek_TextChanged"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" style="height: 16px">
                                    <asp:Label ID="Label52" runat="server" Text="Tarikh Kredit"></asp:Label>
                                    <asp:Label ID="Label55" runat="server" ForeColor="#FF3300" Text="*"></asp:Label>
                                </td>
                                <td colspan="5" style="height: 16px">
                                    <asp:TextBox ID="txtDateCredit" OnTextChanged="txtDateCredit_TextChanged" runat="server" Width="100px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" style="height: 16px">
                                    <asp:Label ID="Label56" runat="server" Text="No. Rujukan"></asp:Label>
                                </td>
                                <td colspan="5" style="height: 16px">
                                    <asp:TextBox ID="txtVoucherNo" runat="server" OnTextChanged="txtVoucherNo_TextChanged" Width="100px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
