            ...
            If Not IsPostBack Then
                ...
                If Session("studentCode") <> Nothing Then
                    ...
                    If Category = "Student Ledger" Then
                        ...
                        str += " CASE WHEN SA.Category='Loan' THEN 0 ELSE sum(sa.transamount) END"
                        str += " ELSE 0 End"
                        str += " End as Credit,"
                        str += " CASE when sa.category = 'Credit Note' or sa.category = 'Debit Note' or sa.category = 'Invoice' THEN"
                        ...
                        str += " Else"
                        str += " CASE WHEN SA.Category='Loan' THEN sum(sa.transamount)"
                        str += " ELSE 0 END"
                        str += " End"
                        str += " END as Debit"
                        str += " FROM SAS_Student ss  "
                        ...
                        str += " order by sa.postedtimestamp,sa.transdate "
