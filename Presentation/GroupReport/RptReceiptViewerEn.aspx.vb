...
Partial Class RptReceiptViewerEn
            ...
            If Not IsPostBack Then
                ...
                Else
                    ...
                    If Session("LaporanHarian") = True Then
                        ...
                        MyReportDocument.Load(Server.MapPath("~/GroupReport/RptDailyReportEn.rpt"))

                    Else

                        MyReportDocument.Load(Server.MapPath("~/GroupReport/RptReceiptEn.rpt"))
