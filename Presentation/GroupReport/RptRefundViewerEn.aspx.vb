...
Partial Class RptRefundViewerEn
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not IsPostBack Then
                ...
                str = " select ss.SASI_MatricNo MatricNo,ss.SASI_ICNo ICNO,ss.SASI_Name StudentName,sa.TransAmount "
                str += " TransAmount,sa.TransCode ReceiptNo,ss.SASS_Code StatusStudent,sa.TransDate TransDate,"
                ...
                Dim s As String = Server.MapPath("~/xml/Refund.xml")
                _DataSet.WriteXml(s)
                ...
                Else
                    ...
                    MyReportDocument.Load(Server.MapPath("~/GroupReport/RptRefundEn.rpt"))
