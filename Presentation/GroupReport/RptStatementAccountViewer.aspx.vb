        ...
        Try
            If Not IsPostBack Then
                ...
                If Not sponsor = "%" Then
                    ...
                    str += " CASE WHEN sa.Description LIKE 'CIMB CLICKS%' THEN sa.TransCode"
                    str += " ELSE"
                    str += " CASE WHEN SA.Subcategory='Loan' THEN SA.TransCode"
                    str += " ELSE SA.BankRecNo END"
                    str += " END"
                    ...
                    str += " AND sa.Category NOT IN ('Loan') "
                    str += " AND ss.SASI_PgId like '" + program + "'"
                    str += " AND ss.SASI_Faculty like '" + faculty + "'"
                    str += " AND st.SASS_Sponsor like '" + sponsor + "'"
                    str += status
                    str += datecondition
                    str += " group by ss.sasi_name,ss.SASI_ICNo,ss.sasi_MatricNo,ss.SASI_PgId,ss.SASI_CurSemYr,sa.Category,SA.Subcategory, ss.SASI_Intake,ss.SASI_CurSem,"
                    ...
                    str += " AND lo.SubType = 'Student' and lo.PostStatus ='Posted' AND lo.Category NOT IN ('Receipt')"
                    str += " AND ss.SASI_PgId like '" + program + "'"
                    str += " AND ss.SASI_Faculty like '" + faculty + "'"
                    str += " AND st.SASS_Sponsor like '" + sponsor + "'"
                    str += status
