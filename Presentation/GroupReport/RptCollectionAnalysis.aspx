<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" AutoEventWireup="false"
    CodeFile="RptCollectionAnalysis.aspx.vb" Inherits="RptCollectionAnalysis" Title="Welcome To SAS" %>
                    ...
                    <table style="border-collapse: collapse;" class="menuoff" onmouseover="className='menuon';"
                        ...
                        <tr>
                            <td style="height: 14px">
                                <asp:ImageButton ID="ibtnNew" runat="server" ImageUrl="../images/add.png" ToolTip="New" OnClick="ibtnNew_Click" />
                            </td>
        ...
        <table class="mainbg" style="width: 100%;">
            <tr>
                ...
                <td class="pagetext" style="height: 39px;text-align: right">
                    <asp:Label ID="lblMenuName" runat="server" Text="University Fund" Width="450px"></asp:Label>
                </td>
