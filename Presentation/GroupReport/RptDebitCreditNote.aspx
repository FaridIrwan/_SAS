<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" AutoEventWireup="false"
    CodeFile="RptDebitCreditNote.aspx.vb" Inherits="RptDebitCreditNote" Title="Welcome To SAS" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function dllValues() {
            ...
            var sem = "0"
            var lbl = false
            sem = document.getElementById("<%=ddlSem.ClientID%>").value
            ...
            <%-- if (document.getElementById("<%=ddlType.ClientID%>").value == "-1") {
                ...
                if ((document.getElementById("<%=ddlStuStatus.ClientID%>").value == "-1") && (document.getElementById("<%=ddlSem.ClientID%>").value == "-1") && (document.getElementById("<%=ChkDateRange.ClientID%>").checked == false)) {
                    if (confirm("Do you Want to Show All Records?")) {
                        ...
                        lbl = true;
                        new_window = window.open('../GroupReport/RptDebitCreditNoteViewer.aspx?fdate=' + fromdate1 + '&tdate=' + todate1, 'SAS', 'width=700,height=500,resizable=1'); new_window.focus();
                        return lbl;
                    }
                    else {
        ...
        function dllValues1() {
            if (document.getElementById("<%=ddlType.ClientID%>").value == "-1") {
                ...
                var lbl = false
                if ((document.getElementById("<%=ddlStuStatus.ClientID%>").value == "-1") && (document.getElementById("<%=ddlSem.ClientID%>").value == "-1")) {
                    if (confirm("Do you Want to Show All Records?")) {
                        lbl = true;
                        new_window = window.open('../GroupReport/RptDebitCreditNoteViewer.aspx', 'SAS', 'width=700,height=500,resizable=1'); new_window.focus();
                        return lbl;
                    }
                    else {
                        if (document.getElementById("<%=ddlStuStatus.ClientID%>").value == "-1") {
            ...
            <tr>
                ...
                <td style="float: left; display: None; visibility: collapse;">
                    <table class="menuoff" onmouseout="className='menuoff';" onmouseover="className='menuon';" style="border-collapse: collapse;">
                        <tr>
                            <td style="width: 3%; height: 14px">
                                <asp:ImageButton ID="ibtnPosting" runat="server" ImageUrl="~/images/gposting.png" ToolTip="Cancel" Visible="false" />
                            </td>
                ...
                <td>
                    <table class="menuoff" onmouseout="className='menuoff';" onmouseover="className='menuon';" style="border-collapse: collapse;">
                        <tr>
                            <td style="width: 3%; height: 14px">
                                <asp:ImageButton ID="ibtnCancel" runat="server" ImageUrl="~/images/cancel.png" OnClick="ibtnCancel_Click" ToolTip="Cancel" />
                            </td>
                            <td style="width: 3%; height: 14px">
                ...
                <td style="float: left; display: None; visibility: collapse; width: 2%; height: 14px">
                    <asp:TextBox ID="txtRecNo" runat="server" AutoPostBack="True" CssClass="text_box" dir="ltr" disabled="disabled" ReadOnly="true" Style="text-align: right" TabIndex="1" Width="52px" Visible="false"></asp:TextBox>
                </td>
                <td style="float: left; display: None; visibility: collapse; width: 2%; height: 14px">
        ...
        <table class="mainbg" style="width: 100%;">
            <tr>
                ...
                <td class="pagetext" style="height: 39px;text-align: right">
                    <asp:Label ID="lblMenuName" runat="server" Text="Debit Note"
                    ...
                    <table style="width: 100%">
                        <tr>
                            <td colspan="2" style="height: 16px">
                                <asp:Label ID="Label49" runat="server" Text="Type"></asp:Label>
                            </td>
                            <td style="height: 16px">
                                <asp:DropDownList ID="ddlType" runat="server" AutoPostBack="True"
                                    OnSelectedIndexChanged="ddlType_SelectedIndexChanged" Width="135px">
                                    <asp:ListItem Value="-1">-- Select --</asp:ListItem>
                                    <%--Editted by Zoya @11/03/2016--%>
                                    <%-- <asp:ListItem Value="Credit">Debit</asp:ListItem>
                                    <asp:ListItem Value="Debit">Credit</asp:ListItem>--%>
                                    <asp:ListItem Value="Debit Note">Debit</asp:ListItem>
                                    <asp:ListItem Value="Credit Note">Credit</asp:ListItem>
                                    <%--Editted by Zoya @11/03/2016--%>
                                </asp:DropDownList>
                            </td>
                        ...
                        <tr>
                            <td colspan="2" style="height: 16px">
                                <asp:Label ID="Label48" runat="server" Text="By Semester"></asp:Label>
                            </td>
                            <td style="height: 16px">
                                <asp:DropDownList ID="ddlSem" runat="server" AutoPostBack="True"
                                    OnSelectedIndexChanged="ddlSem_SelectedIndexChanged" Width="135px"
                                    AppendDataBoundItems="True" onmousedown="this.style.width=''">
                                </asp:DropDownList>
                            </td>
                            <td style="width: 10px; height: 16px">&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="5" style="height: 16px">
                                <asp:DropDownList ID="ddlStuStatus" runat="server" AutoPostBack="True"
