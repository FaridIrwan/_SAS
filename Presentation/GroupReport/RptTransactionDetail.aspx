<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" AutoEventWireup="false" CodeFile="RptTransactionDetail.aspx.vb" Inherits="RptTransactionDetail" Title="Welcome To SAS" %>
                                    ...
                                    <ul id="navbar">
                                        <li><a href="#">
                                            <asp:Image id="ibtnPrint" ImageUrl="~/images/print.png" width="24" height="24" runat="server" />
                                             <asp:Label ID="Label7" runat="server" height="24" cssClass="lblPrintCss">Print</asp:Label>
