<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage3.master" AutoEventWireup="true" CodeFile="RptReceiptCollections.aspx.cs" Inherits="RptReceiptCollections" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function dllValues() {
            ...
            new_window = window.open('../GroupReport/RptReceiptCollectionsViewer.aspx?fdate=' + fromdate1 + '&tdate=' + todate1 + '&ReportType=' + document.getElementById("<%=ddlReportType.ClientID%>").value, 'SAS', 'width=700,height=500,resizable=1'); new_window.focus();
                            ...
                            <table width="100%">
                                <tr>
                                    <td style="height: 16px">
                                        <asp:Label ID="lblReportType" runat="server" Text="Type of Report" Width="80px"></asp:Label>
                                    </td>
                                    <td class="auto-style1">
                                        <asp:DropDownList ID="ddlReportType" runat="server" Width="170px" AutoPostBack="true">
                                            <asp:ListItem Value="-1">-- Please Select --</asp:ListItem>
                                            <asp:ListItem Value="Student">Student Receipt</asp:ListItem>
                                            <asp:ListItem Value="Sponsor">Sponsor Receipt</asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
