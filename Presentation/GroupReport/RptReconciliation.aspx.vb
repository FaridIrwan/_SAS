...
Partial Class RptReconciliation
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack() Then
            ...
            ibtnPrint.Attributes.Add("onclick", "new_window=window.open('../GroupReport/RptReconciliationViewer.aspx','Hanodale','width=520,height=400,resize=0,scrollbars=1');new_window.focus();")

            'Commented By Zoya@26/02/2016
            'ibtnBMReport.Attributes.Add("onclick", "return getDate()")
            'ibtnBMReport.Attributes.Add("onclick", "new_window=window.open('../GroupReport/RptReconciliationViewer.aspx','Hanodale','width=520,height=400,resize=0,scrollbars=1');new_window.focus();")
            'ibtnEnReport.Attributes.Add("onclick", "new_window=window.open('../GroupReport/RptReconciliationViewerEn.aspx','Hanodale','width=520,height=400,resize=0,scrollbars=1');new_window.focus();")
    ...
    Protected Sub ddlReconcilation_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        If ddlReconcilation.SelectedValue = -1 Then
        ...
        ElseIf ddlReconcilation.SelectedValue = 0 Then
            lblfaculty.Visible = True
            lblprogram.Visible = True
            ...
            Session("reconcilation") = ddlReconcilation.SelectedValue
        ElseIf ddlReconcilation.SelectedValue = 1 Then
    ...
    Protected Sub ddlSponsor_SelectedIndexChanged1(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Protected Sub ibtnCancel_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ddlReconcilation.SelectedIndex = -1
