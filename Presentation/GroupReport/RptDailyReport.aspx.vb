...
Partial Class RptDailyReport
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack() Then
            ...
            ibtnPrint.Attributes.Add("onclick", "new_window=window.open('../GroupReport/RptDailyReportViewer.aspx','Hanodale','width=520,height=400,resizable=0');new_window.focus();")

            'Commented By Zoya @26/02/2016
            'ibtnBMReport.Attributes.Add("onclick", "return getDate()")
            'ibtnBMReport.Attributes.Add("onclick", "new_window=window.open('../GroupReport/RptDailyReportViewer.aspx','Hanodale','width=520,height=400,resizable=0');new_window.focus();")
            'ibtnEnReport.Attributes.Add("onclick", "return getDate()")
            'ibtnEnReport.Attributes.Add("onclick", "new_window=window.open('../GroupReport/RptDailyReportViewerEn.aspx','Hanodale','width=520,height=400,resizable=0');new_window.focus();")
            ...
            ibtnView.Attributes.Add("onclick", "new_window=window.open('../GroupReport/RptDailyReportViewer.aspx','Hanodale','width=520,height=400,resizable=0');new_window.focus();")
            dates()
    ...
    'Commented by Zoya @ 26/02/2016
    'Protected Sub ibtnBMReport_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles ibtnBMReport.Click
    '    If ddlStuStatus.SelectedValue <> "-1" Then
    '        Session("sortby") = ddlStuStatus.SelectedValue
    '    End If
    '    Session("fromdate") = txtFrom.Text
    '    Session("todate") = txtTodate.Text
    'End Sub

    'Protected Sub ibtnEnReport_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles ibtnEnReport.Click
    '    If ddlStuStatus.SelectedValue <> "-1" Then
    '        Session("sortby") = ddlStuStatus.SelectedValue
    '    End If
    '    Session("fromdate") = txtFrom.Text
    ...
    'Added by Zoya @ 26/02/2016
    Protected Sub ibtnPrint_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles ibtnPrint.Click
        If ddlStuStatus.SelectedValue <> "-1" Then
            Session("sortby") = ddlStuStatus.SelectedValue
        End If
        Session("fromdate") = txtFrom.Text
    ...
    Protected Sub ibtnView_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles ibtnView.Click
        If ddlStuStatus.SelectedValue <> "-1" Then
            Session("sortby") = ddlStuStatus.SelectedValue
        End If
        Session("fromdate") = txtFrom.Text
